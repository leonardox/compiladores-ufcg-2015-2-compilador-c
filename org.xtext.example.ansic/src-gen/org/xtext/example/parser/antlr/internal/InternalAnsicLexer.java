...
public class InternalAnsicLexer extends Lexer {
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:10966:12: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* )
            // InternalAnsic.g:10966:14: ( '0' .. '9' )+ '.' ( '0' .. '9' )*
            {
            // InternalAnsic.g:10966:14: ( '0' .. '9' )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_O() throws RecognitionException {
        try {
            // InternalAnsic.g:10968:17: ( '0' .. '7' )
            // InternalAnsic.g:10968:19: '0' .. '7'
            {
            matchRange('0','7'); 
    ...
    public final void mRULE_D() throws RecognitionException {
        try {
            // InternalAnsic.g:10970:17: ( '0' .. '9' )
            // InternalAnsic.g:10970:19: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_NZ() throws RecognitionException {
        try {
            // InternalAnsic.g:10972:18: ( '1' .. '9' )
            // InternalAnsic.g:10972:20: '1' .. '9'
            {
            matchRange('1','9'); 
    ...
    public final void mRULE_L() throws RecognitionException {
        try {
            int _type = RULE_L;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:10974:8: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) )
            // InternalAnsic.g:10974:10: ( 'a' .. 'z' | 'A' .. 'Z' | '_' )
            {
    ...
    public final void mRULE_A() throws RecognitionException {
        try {
            // InternalAnsic.g:10976:17: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' '..' '9' ) )
            // InternalAnsic.g:10976:19: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' '..' '9' )
            {
            // InternalAnsic.g:10976:19: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' '..' '9' )
            int alt3=4;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_H() throws RecognitionException {
        try {
            // InternalAnsic.g:10978:17: ( ( 'a' .. 'f' | 'A' .. 'F' | '0' '..' '9' ) )
            // InternalAnsic.g:10978:19: ( 'a' .. 'f' | 'A' .. 'F' | '0' '..' '9' )
            {
            // InternalAnsic.g:10978:19: ( 'a' .. 'f' | 'A' .. 'F' | '0' '..' '9' )
            int alt4=3;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_HP() throws RecognitionException {
        try {
            // InternalAnsic.g:10980:18: ( '0' ( 'x' | 'X' ) )
            // InternalAnsic.g:10980:20: '0' ( 'x' | 'X' )
            {
            match('0'); 
    ...
    public final void mRULE_E() throws RecognitionException {
        try {
            // InternalAnsic.g:10982:17: ( ( 'E' | 'e' ) ( '+' | '-' )? RULE_D '+' )
            // InternalAnsic.g:10982:19: ( 'E' | 'e' ) ( '+' | '-' )? RULE_D '+'
            {
    ...
    public final void mRULE_P() throws RecognitionException {
        try {
            // InternalAnsic.g:10984:17: ( ( 'P' | 'p' ) ( '+' | '-' )? '{' RULE_D '}' '+' )
            // InternalAnsic.g:10984:19: ( 'P' | 'p' ) ( '+' | '-' )? '{' RULE_D '}' '+'
            {
    ...
    public final void mRULE_FS() throws RecognitionException {
        try {
            // InternalAnsic.g:10986:18: ( ( 'f' | 'F' | 'l' | 'L' ) )
            // InternalAnsic.g:10986:20: ( 'f' | 'F' | 'l' | 'L' )
            {
    ...
    public final void mRULE_ES() throws RecognitionException {
        try {
            // InternalAnsic.g:10988:18: ( RULE_A )
            // InternalAnsic.g:10988:20: RULE_A
            {
            mRULE_A(); 
    ...
    public final void mRULE_IS() throws RecognitionException {
        try {
            // InternalAnsic.g:10990:18: ( ( ( 'u' | 'U' ) ( 'l' | 'L' | 'l' 'l' | 'L' 'L' )? | ( 'l' | 'L' | 'l' 'l' | 'L' 'L' ) ( 'u' | 'U' )? ) )
            // InternalAnsic.g:10990:20: ( ( 'u' | 'U' ) ( 'l' | 'L' | 'l' 'l' | 'L' 'L' )? | ( 'l' | 'L' | 'l' 'l' | 'L' 'L' ) ( 'u' | 'U' )? )
            {
            // InternalAnsic.g:10990:20: ( ( 'u' | 'U' ) ( 'l' | 'L' | 'l' 'l' | 'L' 'L' )? | ( 'l' | 'L' | 'l' 'l' | 'L' 'L' ) ( 'u' | 'U' )? )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalAnsic.g:10990:21: ( 'u' | 'U' ) ( 'l' | 'L' | 'l' 'l' | 'L' 'L' )?
                    {
                    ...
                    // InternalAnsic.g:10990:31: ( 'l' | 'L' | 'l' 'l' | 'L' 'L' )?
                    int alt7=5;
                    ...
                    break;
                case 2 :
                    // InternalAnsic.g:10990:58: ( 'l' | 'L' | 'l' 'l' | 'L' 'L' ) ( 'u' | 'U' )?
                    {
                    // InternalAnsic.g:10990:58: ( 'l' | 'L' | 'l' 'l' | 'L' 'L' )
                    int alt8=4;
    ...
    public final void mRULE_CP() throws RecognitionException {
        try {
            // InternalAnsic.g:10992:18: ( ( 'u' | 'U' | 'L' ) )
            // InternalAnsic.g:10992:20: ( 'u' | 'U' | 'L' )
            {
    ...
    public final void mRULE_SP() throws RecognitionException {
        try {
            // InternalAnsic.g:10994:18: ( ( 'u' '8' | 'u' | 'U' | 'L' ) )
            // InternalAnsic.g:10994:20: ( 'u' '8' | 'u' | 'U' | 'L' )
            {
            // InternalAnsic.g:10994:20: ( 'u' '8' | 'u' | 'U' | 'L' )
            int alt11=4;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:10996:9: ( ( ' ' | '\\t' | '\\r' | '\\n' | '\\f' )+ )
            // InternalAnsic.g:10996:11: ( ' ' | '\\t' | '\\r' | '\\n' | '\\f' )+
            {
            // InternalAnsic.g:10996:11: ( ' ' | '\\t' | '\\r' | '\\n' | '\\f' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_I_CONSTANT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:10998:17: ( ( RULE_HP RULE_H '+' ( RULE_IS )? | RULE_NZ RULE_D '*' ( RULE_IS )? | '0' RULE_O '*' ( RULE_IS )? | ( RULE_CP )? '\\'' ( ( '^' | '\\'' | '\\\\' | '\\n' ) | RULE_ES )+ '\\'' ) )
            // InternalAnsic.g:10998:19: ( RULE_HP RULE_H '+' ( RULE_IS )? | RULE_NZ RULE_D '*' ( RULE_IS )? | '0' RULE_O '*' ( RULE_IS )? | ( RULE_CP )? '\\'' ( ( '^' | '\\'' | '\\\\' | '\\n' ) | RULE_ES )+ '\\'' )
            {
            // InternalAnsic.g:10998:19: ( RULE_HP RULE_H '+' ( RULE_IS )? | RULE_NZ RULE_D '*' ( RULE_IS )? | '0' RULE_O '*' ( RULE_IS )? | ( RULE_CP )? '\\'' ( ( '^' | '\\'' | '\\\\' | '\\n' ) | RULE_ES )+ '\\'' )
            int alt18=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt18) {
                case 1 :
                    // InternalAnsic.g:10998:20: RULE_HP RULE_H '+' ( RULE_IS )?
                    {
                    mRULE_HP(); 
                    mRULE_H(); 
                    match('+'); 
                    // InternalAnsic.g:10998:39: ( RULE_IS )?
                    int alt13=2;
                    ...
                    break;
                case 2 :
                    // InternalAnsic.g:10998:48: RULE_NZ RULE_D '*' ( RULE_IS )?
                    {
                    mRULE_NZ(); 
                    mRULE_D(); 
                    match('*'); 
                    // InternalAnsic.g:10998:67: ( RULE_IS )?
                    int alt14=2;
                    ...
                    break;
                case 3 :
                    // InternalAnsic.g:10998:76: '0' RULE_O '*' ( RULE_IS )?
                    {
                    match('0'); 
                    mRULE_O(); 
                    match('*'); 
                    // InternalAnsic.g:10998:91: ( RULE_IS )?
                    int alt15=2;
                    ...
                    break;
                case 4 :
                    // InternalAnsic.g:10998:100: ( RULE_CP )? '\\'' ( ( '^' | '\\'' | '\\\\' | '\\n' ) | RULE_ES )+ '\\''
                    {
                    // InternalAnsic.g:10998:100: ( RULE_CP )?
                    int alt16=2;
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalAnsic.g:10998:136: RULE_ES
                    	    {
                    	    mRULE_ES(); 
    ...
    public final void mRULE_F_CONSTANT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:11000:17: ( ( RULE_D '+' RULE_E ( RULE_FS )? | RULE_D '*' '.' RULE_D '+' ( RULE_E )? ( RULE_FS )? | RULE_D '+' '.' ( RULE_E )? ( RULE_FS )? | RULE_HP RULE_H '+' RULE_P ( RULE_FS )? RULE_HP RULE_H '*' '.' RULE_H '+' RULE_P ( RULE_FS )? | RULE_HP RULE_H '+' '.' RULE_P ( RULE_FS )? ) )
            // InternalAnsic.g:11000:19: ( RULE_D '+' RULE_E ( RULE_FS )? | RULE_D '*' '.' RULE_D '+' ( RULE_E )? ( RULE_FS )? | RULE_D '+' '.' ( RULE_E )? ( RULE_FS )? | RULE_HP RULE_H '+' RULE_P ( RULE_FS )? RULE_HP RULE_H '*' '.' RULE_H '+' RULE_P ( RULE_FS )? | RULE_HP RULE_H '+' '.' RULE_P ( RULE_FS )? )
            {
            // InternalAnsic.g:11000:19: ( RULE_D '+' RULE_E ( RULE_FS )? | RULE_D '*' '.' RULE_D '+' ( RULE_E )? ( RULE_FS )? | RULE_D '+' '.' ( RULE_E )? ( RULE_FS )? | RULE_HP RULE_H '+' RULE_P ( RULE_FS )? RULE_HP RULE_H '*' '.' RULE_H '+' RULE_P ( RULE_FS )? | RULE_HP RULE_H '+' '.' RULE_P ( RULE_FS )? )
            int alt27=5;
            ...
            switch (alt27) {
                case 1 :
                    // InternalAnsic.g:11000:20: RULE_D '+' RULE_E ( RULE_FS )?
                    {
                    mRULE_D(); 
                    match('+'); 
                    mRULE_E(); 
                    // InternalAnsic.g:11000:38: ( RULE_FS )?
                    int alt19=2;
                    ...
                    break;
                case 2 :
                    // InternalAnsic.g:11000:47: RULE_D '*' '.' RULE_D '+' ( RULE_E )? ( RULE_FS )?
                    {
                    mRULE_D(); 
                    match('*'); 
                    match('.'); 
                    mRULE_D(); 
                    match('+'); 
                    // InternalAnsic.g:11000:73: ( RULE_E )?
                    int alt20=2;
                    ...
                    // InternalAnsic.g:11000:81: ( RULE_FS )?
                    int alt21=2;
                    ...
                    break;
                case 3 :
                    // InternalAnsic.g:11000:90: RULE_D '+' '.' ( RULE_E )? ( RULE_FS )?
                    {
                    mRULE_D(); 
                    match('+'); 
                    match('.'); 
                    // InternalAnsic.g:11000:105: ( RULE_E )?
                    int alt22=2;
                    ...
                    // InternalAnsic.g:11000:113: ( RULE_FS )?
                    int alt23=2;
                    ...
                    break;
                case 4 :
                    // InternalAnsic.g:11000:122: RULE_HP RULE_H '+' RULE_P ( RULE_FS )? RULE_HP RULE_H '*' '.' RULE_H '+' RULE_P ( RULE_FS )?
                    {
                    mRULE_HP(); 
                    mRULE_H(); 
                    match('+'); 
                    mRULE_P(); 
                    // InternalAnsic.g:11000:148: ( RULE_FS )?
                    int alt24=2;
                    ...
                    match('+'); 
                    mRULE_P(); 
                    // InternalAnsic.g:11000:198: ( RULE_FS )?
                    int alt25=2;
                    ...
                    break;
                case 5 :
                    // InternalAnsic.g:11000:207: RULE_HP RULE_H '+' '.' RULE_P ( RULE_FS )?
                    {
                    mRULE_HP(); 
                    mRULE_H(); 
                    match('+'); 
                    match('.'); 
                    mRULE_P(); 
                    // InternalAnsic.g:11000:237: ( RULE_FS )?
                    int alt26=2;
    ...
    public final void mRULE_STRING_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:11002:21: ( ( ( RULE_SP )? '\"' ( ( '^' | '\\'' | '\\\\' | '\\n' ) | RULE_ES )* '\"' ( RULE_WS )* )+ )
            // InternalAnsic.g:11002:23: ( ( RULE_SP )? '\"' ( ( '^' | '\\'' | '\\\\' | '\\n' ) | RULE_ES )* '\"' ( RULE_WS )* )+
            {
            // InternalAnsic.g:11002:23: ( ( RULE_SP )? '\"' ( ( '^' | '\\'' | '\\\\' | '\\n' ) | RULE_ES )* '\"' ( RULE_WS )* )+
            int cnt31=0;
            loop31:
            do {
                ...
                switch (alt31) {
            	case 1 :
            	    // InternalAnsic.g:11002:24: ( RULE_SP )? '\"' ( ( '^' | '\\'' | '\\\\' | '\\n' ) | RULE_ES )* '\"' ( RULE_WS )*
            	    {
            	    // InternalAnsic.g:11002:24: ( RULE_SP )?
            	    int alt28=2;
            	    ...
            	    do {
            	    	...
            	    	case 1 :
            	    	    ...
            	    	    break;
            	    	case 2 :
            	    	    // InternalAnsic.g:11002:59: RULE_ES
            	    	    {
            	    	    mRULE_ES(); 
            	    ...
            	    match('\"'); 
            	    // InternalAnsic.g:11002:73: ( RULE_WS )*
            	    loop30:
            	    do {
            	        int alt30=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:11004:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalAnsic.g:11004:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalAnsic.g:11004:11: ( '^' )?
            int alt32=2;
            ...
            // InternalAnsic.g:11004:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop33:
            do {
                int alt33=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:11006:10: ( ( '0' .. '9' )+ )
            // InternalAnsic.g:11006:12: ( '0' .. '9' )+
            {
            // InternalAnsic.g:11006:12: ( '0' .. '9' )+
            int cnt34=0;
            loop34:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:11008:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalAnsic.g:11008:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalAnsic.g:11008:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt37=2;
            ...
            switch (alt37) {
                case 1 :
                    // InternalAnsic.g:11008:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalAnsic.g:11008:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop35:
                    do {
                        int alt35=3;
                    ...
                    break;
                case 2 :
                    // InternalAnsic.g:11008:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalAnsic.g:11008:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop36:
                    do {
                        int alt36=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:11010:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalAnsic.g:11010:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalAnsic.g:11010:24: ( options {greedy=false; } : . )*
            loop38:
            do {
                int alt38=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:11012:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalAnsic.g:11012:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalAnsic.g:11012:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop39:
            do {
                int alt39=2;
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnsic.g:11014:16: ( . )
            // InternalAnsic.g:11014:18: .
            {
            matchAny(); 
    ...
    static final String[] DFA42_transitionS = {
            ...
            "\1\122\4\uffff\1\121\10\uffff\10\66\1\120\1\66\7\uffff\32\66\4\uffff\1\66\1\uffff\15\66\1\117\14\66",
            ...
            "\1\122\4\uffff\1\121\10\uffff\12\66\7\uffff\32\66\4\uffff\1\66\1\uffff\32\66",
            "",
            "\2\u0088\2\uffff\1\u0086\1\uffff\12\u008b",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    ...
                    case 2 : 
                        ...
                        else if ( (LA42_0=='c') ) {s = 5;}

                        else if ( (LA42_0=='r') ) {s = 6;}

                        else if ( (LA42_0=='v') ) {s = 7;}

                        else if ( (LA42_0=='s') ) {s = 8;}

                        else if ( (LA42_0=='l') ) {s = 9;}

                        else if ( (LA42_0=='f') ) {s = 10;}

                        else if ( (LA42_0=='d') ) {s = 11;}

                        else if ( (LA42_0=='u') ) {s = 12;}

                        else if ( (LA42_0=='b') ) {s = 13;}

                        else if ( (LA42_0=='t') ) {s = 14;}

                        else if ( (LA42_0=='e') ) {s = 15;}
