 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.inclusive_or_expression_linhaImpl#getExclusive_or_expression <em>Exclusive or expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.inclusive_or_expression_linhaImpl#getInclusive_or_expression_linha <em>Inclusive or expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class inclusive_or_expression_linhaImpl extends MinimalEObjectImpl.Container implements inclusive_or_expression_linha
{
  ...
  public NotificationChain basicSetExclusive_or_expression(exclusive_or_expression newExclusive_or_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.INCLUSIVE_OR_EXPRESSION_LINHA__EXCLUSIVE_OR_EXPRESSION, oldExclusive_or_expression, newExclusive_or_expression);
  ...
  public void setExclusive_or_expression(exclusive_or_expression newExclusive_or_expression)
  {
    if (newExclusive_or_expression != exclusive_or_expression)
    {
      ...
      if (exclusive_or_expression != null)
        msgs = ((InternalEObject)exclusive_or_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.INCLUSIVE_OR_EXPRESSION_LINHA__EXCLUSIVE_OR_EXPRESSION, null, msgs);
      if (newExclusive_or_expression != null)
        msgs = ((InternalEObject)newExclusive_or_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.INCLUSIVE_OR_EXPRESSION_LINHA__EXCLUSIVE_OR_EXPRESSION, null, msgs);
      msgs = basicSetExclusive_or_expression(newExclusive_or_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.INCLUSIVE_OR_EXPRESSION_LINHA__EXCLUSIVE_OR_EXPRESSION, newExclusive_or_expression, newExclusive_or_expression));
  }
  ...
  public NotificationChain basicSetInclusive_or_expression_linha(inclusive_or_expression_linha newInclusive_or_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.INCLUSIVE_OR_EXPRESSION_LINHA__INCLUSIVE_OR_EXPRESSION_LINHA, oldInclusive_or_expression_linha, newInclusive_or_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setInclusive_or_expression_linha(inclusive_or_expression_linha newInclusive_or_expression_linha)
  {
    if (newInclusive_or_expression_linha != inclusive_or_expression_linha)
    {
      ...
      if (inclusive_or_expression_linha != null)
        msgs = ((InternalEObject)inclusive_or_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.INCLUSIVE_OR_EXPRESSION_LINHA__INCLUSIVE_OR_EXPRESSION_LINHA, null, msgs);
      if (newInclusive_or_expression_linha != null)
        msgs = ((InternalEObject)newInclusive_or_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.INCLUSIVE_OR_EXPRESSION_LINHA__INCLUSIVE_OR_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetInclusive_or_expression_linha(newInclusive_or_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.INCLUSIVE_OR_EXPRESSION_LINHA__INCLUSIVE_OR_EXPRESSION_LINHA, newInclusive_or_expression_linha, newInclusive_or_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.INCLUSIVE_OR_EXPRESSION_LINHA__EXCLUSIVE_OR_EXPRESSION:
        return basicSetExclusive_or_expression(null, msgs);
      case AnsicPackage.INCLUSIVE_OR_EXPRESSION_LINHA__INCLUSIVE_OR_EXPRESSION_LINHA:
