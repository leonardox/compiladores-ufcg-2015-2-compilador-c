 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.designatorImpl#getConstant_expression <em>Constant expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.designatorImpl#getIdentifier <em>Identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class designatorImpl extends MinimalEObjectImpl.Container implements designator
{
  ...
  {
    return AnsicPackage.Literals.DESIGNATOR;
  }
  ...
  public NotificationChain basicSetConstant_expression(conditional_expression newConstant_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DESIGNATOR__CONSTANT_EXPRESSION, oldConstant_expression, newConstant_expression);
  ...
  public void setConstant_expression(conditional_expression newConstant_expression)
  {
    if (newConstant_expression != constant_expression)
    {
      ...
      if (constant_expression != null)
        msgs = ((InternalEObject)constant_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DESIGNATOR__CONSTANT_EXPRESSION, null, msgs);
      if (newConstant_expression != null)
        msgs = ((InternalEObject)newConstant_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DESIGNATOR__CONSTANT_EXPRESSION, null, msgs);
      msgs = basicSetConstant_expression(newConstant_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DESIGNATOR__CONSTANT_EXPRESSION, newConstant_expression, newConstant_expression));
  }
  ...
  public void setIdentifier(String newIdentifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DESIGNATOR__IDENTIFIER, oldIdentifier, identifier));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.DESIGNATOR__CONSTANT_EXPRESSION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AnsicPackage.DESIGNATOR__IDENTIFIER:
