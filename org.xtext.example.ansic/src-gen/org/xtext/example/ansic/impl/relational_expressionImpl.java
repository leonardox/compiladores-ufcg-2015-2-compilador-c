 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.relational_expressionImpl#getShift_expression <em>Shift expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.relational_expressionImpl#getRelational_expression_linha <em>Relational expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class relational_expressionImpl extends MinimalEObjectImpl.Container implements relational_expression
{
  ...
  {
    return AnsicPackage.Literals.RELATIONAL_EXPRESSION;
  }
  ...
  public NotificationChain basicSetShift_expression(shift_expression newShift_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.RELATIONAL_EXPRESSION__SHIFT_EXPRESSION, oldShift_expression, newShift_expression);
  ...
  public void setShift_expression(shift_expression newShift_expression)
  {
    if (newShift_expression != shift_expression)
    {
      ...
      if (shift_expression != null)
        msgs = ((InternalEObject)shift_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.RELATIONAL_EXPRESSION__SHIFT_EXPRESSION, null, msgs);
      if (newShift_expression != null)
        msgs = ((InternalEObject)newShift_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.RELATIONAL_EXPRESSION__SHIFT_EXPRESSION, null, msgs);
      msgs = basicSetShift_expression(newShift_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.RELATIONAL_EXPRESSION__SHIFT_EXPRESSION, newShift_expression, newShift_expression));
  }
  ...
  public NotificationChain basicSetRelational_expression_linha(relational_expression_linha newRelational_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.RELATIONAL_EXPRESSION__RELATIONAL_EXPRESSION_LINHA, oldRelational_expression_linha, newRelational_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRelational_expression_linha(relational_expression_linha newRelational_expression_linha)
  {
    if (newRelational_expression_linha != relational_expression_linha)
    {
      ...
      if (relational_expression_linha != null)
        msgs = ((InternalEObject)relational_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.RELATIONAL_EXPRESSION__RELATIONAL_EXPRESSION_LINHA, null, msgs);
      if (newRelational_expression_linha != null)
        msgs = ((InternalEObject)newRelational_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.RELATIONAL_EXPRESSION__RELATIONAL_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetRelational_expression_linha(newRelational_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.RELATIONAL_EXPRESSION__RELATIONAL_EXPRESSION_LINHA, newRelational_expression_linha, newRelational_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.RELATIONAL_EXPRESSION__SHIFT_EXPRESSION:
        return basicSetShift_expression(null, msgs);
      case AnsicPackage.RELATIONAL_EXPRESSION__RELATIONAL_EXPRESSION_LINHA:
