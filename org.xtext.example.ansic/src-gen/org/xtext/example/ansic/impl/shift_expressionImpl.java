 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.shift_expressionImpl#getAdditive_expression <em>Additive expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.shift_expressionImpl#getShift_expression_linha <em>Shift expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class shift_expressionImpl extends MinimalEObjectImpl.Container implements shift_expression
{
  ...
  {
    return AnsicPackage.Literals.SHIFT_EXPRESSION;
  }
  ...
  public NotificationChain basicSetAdditive_expression(additive_expression newAdditive_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.SHIFT_EXPRESSION__ADDITIVE_EXPRESSION, oldAdditive_expression, newAdditive_expression);
  ...
  public void setAdditive_expression(additive_expression newAdditive_expression)
  {
    if (newAdditive_expression != additive_expression)
    {
      ...
      if (additive_expression != null)
        msgs = ((InternalEObject)additive_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.SHIFT_EXPRESSION__ADDITIVE_EXPRESSION, null, msgs);
      if (newAdditive_expression != null)
        msgs = ((InternalEObject)newAdditive_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.SHIFT_EXPRESSION__ADDITIVE_EXPRESSION, null, msgs);
      msgs = basicSetAdditive_expression(newAdditive_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.SHIFT_EXPRESSION__ADDITIVE_EXPRESSION, newAdditive_expression, newAdditive_expression));
  }
  ...
  public NotificationChain basicSetShift_expression_linha(shift_expression_linha newShift_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.SHIFT_EXPRESSION__SHIFT_EXPRESSION_LINHA, oldShift_expression_linha, newShift_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setShift_expression_linha(shift_expression_linha newShift_expression_linha)
  {
    if (newShift_expression_linha != shift_expression_linha)
    {
      ...
      if (shift_expression_linha != null)
        msgs = ((InternalEObject)shift_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.SHIFT_EXPRESSION__SHIFT_EXPRESSION_LINHA, null, msgs);
      if (newShift_expression_linha != null)
        msgs = ((InternalEObject)newShift_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.SHIFT_EXPRESSION__SHIFT_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetShift_expression_linha(newShift_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.SHIFT_EXPRESSION__SHIFT_EXPRESSION_LINHA, newShift_expression_linha, newShift_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.SHIFT_EXPRESSION__ADDITIVE_EXPRESSION:
        return basicSetAdditive_expression(null, msgs);
      case AnsicPackage.SHIFT_EXPRESSION__SHIFT_EXPRESSION_LINHA:
