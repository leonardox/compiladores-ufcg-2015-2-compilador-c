 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.struct_declaration_listImpl#getStruct_declaration <em>Struct declaration</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.struct_declaration_listImpl#getStruct_declaration_list_linha <em>Struct declaration list linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class struct_declaration_listImpl extends MinimalEObjectImpl.Container implements struct_declaration_list
{
  ...
  {
    return AnsicPackage.Literals.STRUCT_DECLARATION_LIST;
  }
  ...
  public NotificationChain basicSetStruct_declaration(struct_declaration newStruct_declaration, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.STRUCT_DECLARATION_LIST__STRUCT_DECLARATION, oldStruct_declaration, newStruct_declaration);
  ...
  public void setStruct_declaration(struct_declaration newStruct_declaration)
  {
    if (newStruct_declaration != struct_declaration)
    {
      ...
      if (struct_declaration != null)
        msgs = ((InternalEObject)struct_declaration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STRUCT_DECLARATION_LIST__STRUCT_DECLARATION, null, msgs);
      if (newStruct_declaration != null)
        msgs = ((InternalEObject)newStruct_declaration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STRUCT_DECLARATION_LIST__STRUCT_DECLARATION, null, msgs);
      msgs = basicSetStruct_declaration(newStruct_declaration, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.STRUCT_DECLARATION_LIST__STRUCT_DECLARATION, newStruct_declaration, newStruct_declaration));
  }
  ...
  public NotificationChain basicSetStruct_declaration_list_linha(struct_declaration_list_linha newStruct_declaration_list_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.STRUCT_DECLARATION_LIST__STRUCT_DECLARATION_LIST_LINHA, oldStruct_declaration_list_linha, newStruct_declaration_list_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStruct_declaration_list_linha(struct_declaration_list_linha newStruct_declaration_list_linha)
  {
    if (newStruct_declaration_list_linha != struct_declaration_list_linha)
    {
      ...
      if (struct_declaration_list_linha != null)
        msgs = ((InternalEObject)struct_declaration_list_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STRUCT_DECLARATION_LIST__STRUCT_DECLARATION_LIST_LINHA, null, msgs);
      if (newStruct_declaration_list_linha != null)
        msgs = ((InternalEObject)newStruct_declaration_list_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STRUCT_DECLARATION_LIST__STRUCT_DECLARATION_LIST_LINHA, null, msgs);
      msgs = basicSetStruct_declaration_list_linha(newStruct_declaration_list_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.STRUCT_DECLARATION_LIST__STRUCT_DECLARATION_LIST_LINHA, newStruct_declaration_list_linha, newStruct_declaration_list_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.STRUCT_DECLARATION_LIST__STRUCT_DECLARATION:
        return basicSetStruct_declaration(null, msgs);
      case AnsicPackage.STRUCT_DECLARATION_LIST__STRUCT_DECLARATION_LIST_LINHA:
