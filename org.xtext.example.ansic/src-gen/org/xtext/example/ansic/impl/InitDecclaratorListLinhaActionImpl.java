 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.InitDecclaratorListLinhaActionImpl#getInit_declarator <em>Init declarator</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.InitDecclaratorListLinhaActionImpl#getInit_declarator_list_linha <em>Init declarator list linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InitDecclaratorListLinhaActionImpl extends init_declarator_list_linhaImpl implements InitDecclaratorListLinhaAction
{
  ...
  {
    return AnsicPackage.Literals.INIT_DECCLARATOR_LIST_LINHA_ACTION;
  }
  ...
  public NotificationChain basicSetInit_declarator(init_declarator newInit_declarator, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.INIT_DECCLARATOR_LIST_LINHA_ACTION__INIT_DECLARATOR, oldInit_declarator, newInit_declarator);
  ...
  public void setInit_declarator(init_declarator newInit_declarator)
  {
    if (newInit_declarator != init_declarator)
    {
      ...
      if (init_declarator != null)
        msgs = ((InternalEObject)init_declarator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.INIT_DECCLARATOR_LIST_LINHA_ACTION__INIT_DECLARATOR, null, msgs);
      if (newInit_declarator != null)
        msgs = ((InternalEObject)newInit_declarator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.INIT_DECCLARATOR_LIST_LINHA_ACTION__INIT_DECLARATOR, null, msgs);
      msgs = basicSetInit_declarator(newInit_declarator, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.INIT_DECCLARATOR_LIST_LINHA_ACTION__INIT_DECLARATOR, newInit_declarator, newInit_declarator));
  }
  ...
  public NotificationChain basicSetInit_declarator_list_linha(init_declarator_list_linha newInit_declarator_list_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.INIT_DECCLARATOR_LIST_LINHA_ACTION__INIT_DECLARATOR_LIST_LINHA, oldInit_declarator_list_linha, newInit_declarator_list_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setInit_declarator_list_linha(init_declarator_list_linha newInit_declarator_list_linha)
  {
    if (newInit_declarator_list_linha != init_declarator_list_linha)
    {
      ...
      if (init_declarator_list_linha != null)
        msgs = ((InternalEObject)init_declarator_list_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.INIT_DECCLARATOR_LIST_LINHA_ACTION__INIT_DECLARATOR_LIST_LINHA, null, msgs);
      if (newInit_declarator_list_linha != null)
        msgs = ((InternalEObject)newInit_declarator_list_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.INIT_DECCLARATOR_LIST_LINHA_ACTION__INIT_DECLARATOR_LIST_LINHA, null, msgs);
      msgs = basicSetInit_declarator_list_linha(newInit_declarator_list_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.INIT_DECCLARATOR_LIST_LINHA_ACTION__INIT_DECLARATOR_LIST_LINHA, newInit_declarator_list_linha, newInit_declarator_list_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.INIT_DECCLARATOR_LIST_LINHA_ACTION__INIT_DECLARATOR:
        return basicSetInit_declarator(null, msgs);
      case AnsicPackage.INIT_DECCLARATOR_LIST_LINHA_ACTION__INIT_DECLARATOR_LIST_LINHA:
