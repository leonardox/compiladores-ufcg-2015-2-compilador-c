 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.exclusive_or_expressionImpl#getAnd_expression <em>And expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.exclusive_or_expressionImpl#getExclusive_or_expression_linha <em>Exclusive or expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class exclusive_or_expressionImpl extends MinimalEObjectImpl.Container implements exclusive_or_expression
{
  ...
  {
    return AnsicPackage.Literals.EXCLUSIVE_OR_EXPRESSION;
  }
  ...
  public NotificationChain basicSetAnd_expression(and_expression newAnd_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.EXCLUSIVE_OR_EXPRESSION__AND_EXPRESSION, oldAnd_expression, newAnd_expression);
  ...
  public void setAnd_expression(and_expression newAnd_expression)
  {
    if (newAnd_expression != and_expression)
    {
      ...
      if (and_expression != null)
        msgs = ((InternalEObject)and_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXCLUSIVE_OR_EXPRESSION__AND_EXPRESSION, null, msgs);
      if (newAnd_expression != null)
        msgs = ((InternalEObject)newAnd_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXCLUSIVE_OR_EXPRESSION__AND_EXPRESSION, null, msgs);
      msgs = basicSetAnd_expression(newAnd_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.EXCLUSIVE_OR_EXPRESSION__AND_EXPRESSION, newAnd_expression, newAnd_expression));
  }
  ...
  public NotificationChain basicSetExclusive_or_expression_linha(exclusive_or_expression_linha newExclusive_or_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION_LINHA, oldExclusive_or_expression_linha, newExclusive_or_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExclusive_or_expression_linha(exclusive_or_expression_linha newExclusive_or_expression_linha)
  {
    if (newExclusive_or_expression_linha != exclusive_or_expression_linha)
    {
      ...
      if (exclusive_or_expression_linha != null)
        msgs = ((InternalEObject)exclusive_or_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION_LINHA, null, msgs);
      if (newExclusive_or_expression_linha != null)
        msgs = ((InternalEObject)newExclusive_or_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetExclusive_or_expression_linha(newExclusive_or_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION_LINHA, newExclusive_or_expression_linha, newExclusive_or_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.EXCLUSIVE_OR_EXPRESSION__AND_EXPRESSION:
        return basicSetAnd_expression(null, msgs);
      case AnsicPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION_LINHA:
