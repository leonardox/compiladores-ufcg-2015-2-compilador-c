 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.abstract_declaratorImpl#getPointer <em>Pointer</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.abstract_declaratorImpl#getDirect_abstract_declarator <em>Direct abstract declarator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class abstract_declaratorImpl extends MinimalEObjectImpl.Container implements abstract_declarator
{
  ...
  {
    return AnsicPackage.Literals.ABSTRACT_DECLARATOR;
  }
  ...
  public NotificationChain basicSetPointer(pointer newPointer, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.ABSTRACT_DECLARATOR__POINTER, oldPointer, newPointer);
  ...
  public void setPointer(pointer newPointer)
  {
    if (newPointer != pointer)
    {
      ...
      if (pointer != null)
        msgs = ((InternalEObject)pointer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.ABSTRACT_DECLARATOR__POINTER, null, msgs);
      if (newPointer != null)
        msgs = ((InternalEObject)newPointer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.ABSTRACT_DECLARATOR__POINTER, null, msgs);
      msgs = basicSetPointer(newPointer, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.ABSTRACT_DECLARATOR__POINTER, newPointer, newPointer));
  }
  ...
  public NotificationChain basicSetDirect_abstract_declarator(direct_abstract_declarator newDirect_abstract_declarator, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR, oldDirect_abstract_declarator, newDirect_abstract_declarator);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDirect_abstract_declarator(direct_abstract_declarator newDirect_abstract_declarator)
  {
    if (newDirect_abstract_declarator != direct_abstract_declarator)
    {
      ...
      if (direct_abstract_declarator != null)
        msgs = ((InternalEObject)direct_abstract_declarator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR, null, msgs);
      if (newDirect_abstract_declarator != null)
        msgs = ((InternalEObject)newDirect_abstract_declarator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR, null, msgs);
      msgs = basicSetDirect_abstract_declarator(newDirect_abstract_declarator, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR, newDirect_abstract_declarator, newDirect_abstract_declarator));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.ABSTRACT_DECLARATOR__POINTER:
        return basicSetPointer(null, msgs);
      case AnsicPackage.ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR:
