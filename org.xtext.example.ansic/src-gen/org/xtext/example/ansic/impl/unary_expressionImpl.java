 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.unary_expressionImpl#getPostfix_expression <em>Postfix expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.unary_expressionImpl#getUnary_expression <em>Unary expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.unary_expressionImpl#getUnary_operator <em>Unary operator</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.unary_expressionImpl#getCast_expression <em>Cast expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.unary_expressionImpl#getType_name <em>Type name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class unary_expressionImpl extends MinimalEObjectImpl.Container implements unary_expression
{
  ...
  {
    return AnsicPackage.Literals.UNARY_EXPRESSION;
  }
  ...
  public NotificationChain basicSetPostfix_expression(postfix_expression newPostfix_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.UNARY_EXPRESSION__POSTFIX_EXPRESSION, oldPostfix_expression, newPostfix_expression);
  ...
  public void setPostfix_expression(postfix_expression newPostfix_expression)
  {
    if (newPostfix_expression != postfix_expression)
    {
      ...
      if (postfix_expression != null)
        msgs = ((InternalEObject)postfix_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.UNARY_EXPRESSION__POSTFIX_EXPRESSION, null, msgs);
      if (newPostfix_expression != null)
        msgs = ((InternalEObject)newPostfix_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.UNARY_EXPRESSION__POSTFIX_EXPRESSION, null, msgs);
      msgs = basicSetPostfix_expression(newPostfix_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.UNARY_EXPRESSION__POSTFIX_EXPRESSION, newPostfix_expression, newPostfix_expression));
  }
  ...
  public NotificationChain basicSetUnary_expression(unary_expression newUnary_expression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.UNARY_EXPRESSION__UNARY_EXPRESSION, oldUnary_expression, newUnary_expression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setUnary_expression(unary_expression newUnary_expression)
  {
    if (newUnary_expression != unary_expression)
    {
      ...
      if (unary_expression != null)
        msgs = ((InternalEObject)unary_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.UNARY_EXPRESSION__UNARY_EXPRESSION, null, msgs);
      if (newUnary_expression != null)
        msgs = ((InternalEObject)newUnary_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.UNARY_EXPRESSION__UNARY_EXPRESSION, null, msgs);
      msgs = basicSetUnary_expression(newUnary_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.UNARY_EXPRESSION__UNARY_EXPRESSION, newUnary_expression, newUnary_expression));
  }
  ...
  public void setUnary_operator(String newUnary_operator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.UNARY_EXPRESSION__UNARY_OPERATOR, oldUnary_operator, unary_operator));
  }
  ...
  public NotificationChain basicSetCast_expression(cast_expression newCast_expression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.UNARY_EXPRESSION__CAST_EXPRESSION, oldCast_expression, newCast_expression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCast_expression(cast_expression newCast_expression)
  {
    if (newCast_expression != cast_expression)
    {
      ...
      if (cast_expression != null)
        msgs = ((InternalEObject)cast_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.UNARY_EXPRESSION__CAST_EXPRESSION, null, msgs);
      if (newCast_expression != null)
        msgs = ((InternalEObject)newCast_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.UNARY_EXPRESSION__CAST_EXPRESSION, null, msgs);
      msgs = basicSetCast_expression(newCast_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.UNARY_EXPRESSION__CAST_EXPRESSION, newCast_expression, newCast_expression));
  }
  ...
  public NotificationChain basicSetType_name(type_name newType_name, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.UNARY_EXPRESSION__TYPE_NAME, oldType_name, newType_name);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setType_name(type_name newType_name)
  {
    if (newType_name != type_name)
    {
      NotificationChain msgs = null;
      if (type_name != null)
        msgs = ((InternalEObject)type_name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.UNARY_EXPRESSION__TYPE_NAME, null, msgs);
      if (newType_name != null)
        msgs = ((InternalEObject)newType_name).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.UNARY_EXPRESSION__TYPE_NAME, null, msgs);
      msgs = basicSetType_name(newType_name, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.UNARY_EXPRESSION__TYPE_NAME, newType_name, newType_name));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.UNARY_EXPRESSION__POSTFIX_EXPRESSION:
        return basicSetPostfix_expression(null, msgs);
      case AnsicPackage.UNARY_EXPRESSION__UNARY_EXPRESSION:
        return basicSetUnary_expression(null, msgs);
      case AnsicPackage.UNARY_EXPRESSION__CAST_EXPRESSION:
        return basicSetCast_expression(null, msgs);
      case AnsicPackage.UNARY_EXPRESSION__TYPE_NAME:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AnsicPackage.UNARY_EXPRESSION__UNARY_OPERATOR:
