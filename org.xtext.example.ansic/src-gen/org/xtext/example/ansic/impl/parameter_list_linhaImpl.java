 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.parameter_list_linhaImpl#getParameter_declaration <em>Parameter declaration</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.parameter_list_linhaImpl#getParameter_list_linha <em>Parameter list linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class parameter_list_linhaImpl extends MinimalEObjectImpl.Container implements parameter_list_linha
{
  ...
  public NotificationChain basicSetParameter_declaration(parameter_declaration newParameter_declaration, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.PARAMETER_LIST_LINHA__PARAMETER_DECLARATION, oldParameter_declaration, newParameter_declaration);
  ...
  public void setParameter_declaration(parameter_declaration newParameter_declaration)
  {
    if (newParameter_declaration != parameter_declaration)
    {
      ...
      if (parameter_declaration != null)
        msgs = ((InternalEObject)parameter_declaration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.PARAMETER_LIST_LINHA__PARAMETER_DECLARATION, null, msgs);
      if (newParameter_declaration != null)
        msgs = ((InternalEObject)newParameter_declaration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.PARAMETER_LIST_LINHA__PARAMETER_DECLARATION, null, msgs);
      msgs = basicSetParameter_declaration(newParameter_declaration, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.PARAMETER_LIST_LINHA__PARAMETER_DECLARATION, newParameter_declaration, newParameter_declaration));
  }
  ...
  public EList<parameter_list_linha> getParameter_list_linha()
  {
    ...
    {
      parameter_list_linha = new EObjectContainmentEList<parameter_list_linha>(parameter_list_linha.class, this, AnsicPackage.PARAMETER_LIST_LINHA__PARAMETER_LIST_LINHA);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.PARAMETER_LIST_LINHA__PARAMETER_DECLARATION:
        return basicSetParameter_declaration(null, msgs);
      case AnsicPackage.PARAMETER_LIST_LINHA__PARAMETER_LIST_LINHA:
