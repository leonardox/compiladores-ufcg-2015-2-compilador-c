 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.static_assert_declarationImpl#getConstant_expression <em>Constant expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class static_assert_declarationImpl extends MinimalEObjectImpl.Container implements static_assert_declaration
{
  ...
  {
    return AnsicPackage.Literals.STATIC_ASSERT_DECLARATION;
  }
  ...
  public NotificationChain basicSetConstant_expression(constant_expression newConstant_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.STATIC_ASSERT_DECLARATION__CONSTANT_EXPRESSION, oldConstant_expression, newConstant_expression);
  ...
  public void setConstant_expression(constant_expression newConstant_expression)
  {
    if (newConstant_expression != constant_expression)
    {
      ...
      if (constant_expression != null)
        msgs = ((InternalEObject)constant_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STATIC_ASSERT_DECLARATION__CONSTANT_EXPRESSION, null, msgs);
      if (newConstant_expression != null)
        msgs = ((InternalEObject)newConstant_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STATIC_ASSERT_DECLARATION__CONSTANT_EXPRESSION, null, msgs);
      msgs = basicSetConstant_expression(newConstant_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.STATIC_ASSERT_DECLARATION__CONSTANT_EXPRESSION, newConstant_expression, newConstant_expression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.STATIC_ASSERT_DECLARATION__CONSTANT_EXPRESSION:
