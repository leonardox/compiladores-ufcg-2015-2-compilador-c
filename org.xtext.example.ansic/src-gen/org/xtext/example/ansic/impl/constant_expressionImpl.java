 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.constant_expressionImpl#getConditional_expression <em>Conditional expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class constant_expressionImpl extends MinimalEObjectImpl.Container implements constant_expression
{
  ...
  {
    return AnsicPackage.Literals.CONSTANT_EXPRESSION;
  }
  ...
  public NotificationChain basicSetConditional_expression(conditional_expression newConditional_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.CONSTANT_EXPRESSION__CONDITIONAL_EXPRESSION, oldConditional_expression, newConditional_expression);
  ...
  public void setConditional_expression(conditional_expression newConditional_expression)
  {
    if (newConditional_expression != conditional_expression)
    {
      ...
      if (conditional_expression != null)
        msgs = ((InternalEObject)conditional_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.CONSTANT_EXPRESSION__CONDITIONAL_EXPRESSION, null, msgs);
      if (newConditional_expression != null)
        msgs = ((InternalEObject)newConditional_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.CONSTANT_EXPRESSION__CONDITIONAL_EXPRESSION, null, msgs);
      msgs = basicSetConditional_expression(newConditional_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.CONSTANT_EXPRESSION__CONDITIONAL_EXPRESSION, newConditional_expression, newConditional_expression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.CONSTANT_EXPRESSION__CONDITIONAL_EXPRESSION:
