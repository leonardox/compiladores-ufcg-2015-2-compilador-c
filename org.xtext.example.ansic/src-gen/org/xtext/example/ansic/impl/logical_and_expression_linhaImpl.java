 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.logical_and_expression_linhaImpl#getInclusive_or_expression <em>Inclusive or expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.logical_and_expression_linhaImpl#getLogical_and_expression_linha <em>Logical and expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class logical_and_expression_linhaImpl extends MinimalEObjectImpl.Container implements logical_and_expression_linha
{
  ...
  public NotificationChain basicSetInclusive_or_expression(inclusive_or_expression newInclusive_or_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.LOGICAL_AND_EXPRESSION_LINHA__INCLUSIVE_OR_EXPRESSION, oldInclusive_or_expression, newInclusive_or_expression);
  ...
  public void setInclusive_or_expression(inclusive_or_expression newInclusive_or_expression)
  {
    if (newInclusive_or_expression != inclusive_or_expression)
    {
      ...
      if (inclusive_or_expression != null)
        msgs = ((InternalEObject)inclusive_or_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.LOGICAL_AND_EXPRESSION_LINHA__INCLUSIVE_OR_EXPRESSION, null, msgs);
      if (newInclusive_or_expression != null)
        msgs = ((InternalEObject)newInclusive_or_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.LOGICAL_AND_EXPRESSION_LINHA__INCLUSIVE_OR_EXPRESSION, null, msgs);
      msgs = basicSetInclusive_or_expression(newInclusive_or_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.LOGICAL_AND_EXPRESSION_LINHA__INCLUSIVE_OR_EXPRESSION, newInclusive_or_expression, newInclusive_or_expression));
  }
  ...
  public NotificationChain basicSetLogical_and_expression_linha(logical_and_expression_linha newLogical_and_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.LOGICAL_AND_EXPRESSION_LINHA__LOGICAL_AND_EXPRESSION_LINHA, oldLogical_and_expression_linha, newLogical_and_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLogical_and_expression_linha(logical_and_expression_linha newLogical_and_expression_linha)
  {
    if (newLogical_and_expression_linha != logical_and_expression_linha)
    {
      ...
      if (logical_and_expression_linha != null)
        msgs = ((InternalEObject)logical_and_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.LOGICAL_AND_EXPRESSION_LINHA__LOGICAL_AND_EXPRESSION_LINHA, null, msgs);
      if (newLogical_and_expression_linha != null)
        msgs = ((InternalEObject)newLogical_and_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.LOGICAL_AND_EXPRESSION_LINHA__LOGICAL_AND_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetLogical_and_expression_linha(newLogical_and_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.LOGICAL_AND_EXPRESSION_LINHA__LOGICAL_AND_EXPRESSION_LINHA, newLogical_and_expression_linha, newLogical_and_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.LOGICAL_AND_EXPRESSION_LINHA__INCLUSIVE_OR_EXPRESSION:
        return basicSetInclusive_or_expression(null, msgs);
      case AnsicPackage.LOGICAL_AND_EXPRESSION_LINHA__LOGICAL_AND_EXPRESSION_LINHA:
