 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.conditional_expressionImpl#getLogical_or_expression <em>Logical or expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.conditional_expressionImpl#getConditional_expression_linha <em>Conditional expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class conditional_expressionImpl extends MinimalEObjectImpl.Container implements conditional_expression
{
  ...
  {
    return AnsicPackage.Literals.CONDITIONAL_EXPRESSION;
  }
  ...
  public NotificationChain basicSetLogical_or_expression(logical_or_expression newLogical_or_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.CONDITIONAL_EXPRESSION__LOGICAL_OR_EXPRESSION, oldLogical_or_expression, newLogical_or_expression);
  ...
  public void setLogical_or_expression(logical_or_expression newLogical_or_expression)
  {
    if (newLogical_or_expression != logical_or_expression)
    {
      ...
      if (logical_or_expression != null)
        msgs = ((InternalEObject)logical_or_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.CONDITIONAL_EXPRESSION__LOGICAL_OR_EXPRESSION, null, msgs);
      if (newLogical_or_expression != null)
        msgs = ((InternalEObject)newLogical_or_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.CONDITIONAL_EXPRESSION__LOGICAL_OR_EXPRESSION, null, msgs);
      msgs = basicSetLogical_or_expression(newLogical_or_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.CONDITIONAL_EXPRESSION__LOGICAL_OR_EXPRESSION, newLogical_or_expression, newLogical_or_expression));
  }
  ...
  public NotificationChain basicSetConditional_expression_linha(conditional_expression_linha newConditional_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.CONDITIONAL_EXPRESSION__CONDITIONAL_EXPRESSION_LINHA, oldConditional_expression_linha, newConditional_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setConditional_expression_linha(conditional_expression_linha newConditional_expression_linha)
  {
    if (newConditional_expression_linha != conditional_expression_linha)
    {
      ...
      if (conditional_expression_linha != null)
        msgs = ((InternalEObject)conditional_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.CONDITIONAL_EXPRESSION__CONDITIONAL_EXPRESSION_LINHA, null, msgs);
      if (newConditional_expression_linha != null)
        msgs = ((InternalEObject)newConditional_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.CONDITIONAL_EXPRESSION__CONDITIONAL_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetConditional_expression_linha(newConditional_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.CONDITIONAL_EXPRESSION__CONDITIONAL_EXPRESSION_LINHA, newConditional_expression_linha, newConditional_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.CONDITIONAL_EXPRESSION__LOGICAL_OR_EXPRESSION:
        return basicSetLogical_or_expression(null, msgs);
      case AnsicPackage.CONDITIONAL_EXPRESSION__CONDITIONAL_EXPRESSION_LINHA:
