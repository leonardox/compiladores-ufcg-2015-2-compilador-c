 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.multiplicative_expressionImpl#getCast_expression <em>Cast expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.multiplicative_expressionImpl#getMultiplicative_expression_linha <em>Multiplicative expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class multiplicative_expressionImpl extends MinimalEObjectImpl.Container implements multiplicative_expression
{
  ...
  {
    return AnsicPackage.Literals.MULTIPLICATIVE_EXPRESSION;
  }
  ...
  public NotificationChain basicSetCast_expression(cast_expression newCast_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.MULTIPLICATIVE_EXPRESSION__CAST_EXPRESSION, oldCast_expression, newCast_expression);
  ...
  public void setCast_expression(cast_expression newCast_expression)
  {
    if (newCast_expression != cast_expression)
    {
      ...
      if (cast_expression != null)
        msgs = ((InternalEObject)cast_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.MULTIPLICATIVE_EXPRESSION__CAST_EXPRESSION, null, msgs);
      if (newCast_expression != null)
        msgs = ((InternalEObject)newCast_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.MULTIPLICATIVE_EXPRESSION__CAST_EXPRESSION, null, msgs);
      msgs = basicSetCast_expression(newCast_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.MULTIPLICATIVE_EXPRESSION__CAST_EXPRESSION, newCast_expression, newCast_expression));
  }
  ...
  public NotificationChain basicSetMultiplicative_expression_linha(multiplicative_expression_linha newMultiplicative_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.MULTIPLICATIVE_EXPRESSION__MULTIPLICATIVE_EXPRESSION_LINHA, oldMultiplicative_expression_linha, newMultiplicative_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMultiplicative_expression_linha(multiplicative_expression_linha newMultiplicative_expression_linha)
  {
    if (newMultiplicative_expression_linha != multiplicative_expression_linha)
    {
      ...
      if (multiplicative_expression_linha != null)
        msgs = ((InternalEObject)multiplicative_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.MULTIPLICATIVE_EXPRESSION__MULTIPLICATIVE_EXPRESSION_LINHA, null, msgs);
      if (newMultiplicative_expression_linha != null)
        msgs = ((InternalEObject)newMultiplicative_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.MULTIPLICATIVE_EXPRESSION__MULTIPLICATIVE_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetMultiplicative_expression_linha(newMultiplicative_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.MULTIPLICATIVE_EXPRESSION__MULTIPLICATIVE_EXPRESSION_LINHA, newMultiplicative_expression_linha, newMultiplicative_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.MULTIPLICATIVE_EXPRESSION__CAST_EXPRESSION:
        return basicSetCast_expression(null, msgs);
      case AnsicPackage.MULTIPLICATIVE_EXPRESSION__MULTIPLICATIVE_EXPRESSION_LINHA:
