...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Direct Declarator Linha Action</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.DirectDeclaratorLinhaActionImpl#getDirect_declarator_complemento <em>Direct declarator complemento</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.DirectDeclaratorLinhaActionImpl#getDirect_declarator_linha <em>Direct declarator linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DirectDeclaratorLinhaActionImpl extends direct_declarator_linhaImpl implements DirectDeclaratorLinhaAction
{
  /**
   ...
   * @generated
   */
  protected DirectDeclaratorLinhaActionImpl()
  {
    super();
  }
  ...
  {
    return AnsicPackage.Literals.DIRECT_DECLARATOR_LINHA_ACTION;
  }
  ...
  public NotificationChain basicSetDirect_declarator_complemento(direct_declarator_complemento newDirect_declarator_complemento, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_LINHA_ACTION__DIRECT_DECLARATOR_COMPLEMENTO, oldDirect_declarator_complemento, newDirect_declarator_complemento);
  ...
  public void setDirect_declarator_complemento(direct_declarator_complemento newDirect_declarator_complemento)
  {
    if (newDirect_declarator_complemento != direct_declarator_complemento)
    {
      ...
      if (direct_declarator_complemento != null)
        msgs = ((InternalEObject)direct_declarator_complemento).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_LINHA_ACTION__DIRECT_DECLARATOR_COMPLEMENTO, null, msgs);
      if (newDirect_declarator_complemento != null)
        msgs = ((InternalEObject)newDirect_declarator_complemento).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_LINHA_ACTION__DIRECT_DECLARATOR_COMPLEMENTO, null, msgs);
      msgs = basicSetDirect_declarator_complemento(newDirect_declarator_complemento, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_LINHA_ACTION__DIRECT_DECLARATOR_COMPLEMENTO, newDirect_declarator_complemento, newDirect_declarator_complemento));
  }
  ...
  public NotificationChain basicSetDirect_declarator_linha(direct_declarator_linha newDirect_declarator_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_LINHA_ACTION__DIRECT_DECLARATOR_LINHA, oldDirect_declarator_linha, newDirect_declarator_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDirect_declarator_linha(direct_declarator_linha newDirect_declarator_linha)
  {
    if (newDirect_declarator_linha != direct_declarator_linha)
    {
      ...
      if (direct_declarator_linha != null)
        msgs = ((InternalEObject)direct_declarator_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_LINHA_ACTION__DIRECT_DECLARATOR_LINHA, null, msgs);
      if (newDirect_declarator_linha != null)
        msgs = ((InternalEObject)newDirect_declarator_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_LINHA_ACTION__DIRECT_DECLARATOR_LINHA, null, msgs);
      msgs = basicSetDirect_declarator_linha(newDirect_declarator_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_LINHA_ACTION__DIRECT_DECLARATOR_LINHA, newDirect_declarator_linha, newDirect_declarator_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.DIRECT_DECLARATOR_LINHA_ACTION__DIRECT_DECLARATOR_COMPLEMENTO:
        return basicSetDirect_declarator_complemento(null, msgs);
      case AnsicPackage.DIRECT_DECLARATOR_LINHA_ACTION__DIRECT_DECLARATOR_LINHA:
...
} //DirectDeclaratorLinhaActionImpl
