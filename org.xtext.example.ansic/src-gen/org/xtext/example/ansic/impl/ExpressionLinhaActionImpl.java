...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Expression Linha Action</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.ExpressionLinhaActionImpl#getAssignment_expression <em>Assignment expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.ExpressionLinhaActionImpl#getExpression_linha <em>Expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionLinhaActionImpl extends expression_linhaImpl implements ExpressionLinhaAction
{
  /**
   ...
   * @generated
   */
  protected ExpressionLinhaActionImpl()
  {
    super();
  }
  ...
  {
    return AnsicPackage.Literals.EXPRESSION_LINHA_ACTION;
  }
  ...
  public NotificationChain basicSetAssignment_expression(assignment_expression newAssignment_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.EXPRESSION_LINHA_ACTION__ASSIGNMENT_EXPRESSION, oldAssignment_expression, newAssignment_expression);
  ...
  public void setAssignment_expression(assignment_expression newAssignment_expression)
  {
    if (newAssignment_expression != assignment_expression)
    {
      ...
      if (assignment_expression != null)
        msgs = ((InternalEObject)assignment_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXPRESSION_LINHA_ACTION__ASSIGNMENT_EXPRESSION, null, msgs);
      if (newAssignment_expression != null)
        msgs = ((InternalEObject)newAssignment_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXPRESSION_LINHA_ACTION__ASSIGNMENT_EXPRESSION, null, msgs);
      msgs = basicSetAssignment_expression(newAssignment_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.EXPRESSION_LINHA_ACTION__ASSIGNMENT_EXPRESSION, newAssignment_expression, newAssignment_expression));
  }
  ...
  public NotificationChain basicSetExpression_linha(expression_linha newExpression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.EXPRESSION_LINHA_ACTION__EXPRESSION_LINHA, oldExpression_linha, newExpression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExpression_linha(expression_linha newExpression_linha)
  {
    if (newExpression_linha != expression_linha)
    {
      ...
      if (expression_linha != null)
        msgs = ((InternalEObject)expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXPRESSION_LINHA_ACTION__EXPRESSION_LINHA, null, msgs);
      if (newExpression_linha != null)
        msgs = ((InternalEObject)newExpression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXPRESSION_LINHA_ACTION__EXPRESSION_LINHA, null, msgs);
      msgs = basicSetExpression_linha(newExpression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.EXPRESSION_LINHA_ACTION__EXPRESSION_LINHA, newExpression_linha, newExpression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.EXPRESSION_LINHA_ACTION__ASSIGNMENT_EXPRESSION:
        return basicSetAssignment_expression(null, msgs);
      case AnsicPackage.EXPRESSION_LINHA_ACTION__EXPRESSION_LINHA:
