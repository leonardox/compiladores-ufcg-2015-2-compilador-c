 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.identifier_listImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.identifier_listImpl#getIdentifier_list_linha <em>Identifier list linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class identifier_listImpl extends MinimalEObjectImpl.Container implements identifier_list
{
  ...
  {
    return AnsicPackage.Literals.IDENTIFIER_LIST;
  }
  ...
  public void setIdentifier(String newIdentifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.IDENTIFIER_LIST__IDENTIFIER, oldIdentifier, identifier));
  }
  ...
  public NotificationChain basicSetIdentifier_list_linha(identifier_list_linha newIdentifier_list_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.IDENTIFIER_LIST__IDENTIFIER_LIST_LINHA, oldIdentifier_list_linha, newIdentifier_list_linha);
  ...
  public void setIdentifier_list_linha(identifier_list_linha newIdentifier_list_linha)
  {
    if (newIdentifier_list_linha != identifier_list_linha)
    {
      ...
      if (identifier_list_linha != null)
        msgs = ((InternalEObject)identifier_list_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.IDENTIFIER_LIST__IDENTIFIER_LIST_LINHA, null, msgs);
      if (newIdentifier_list_linha != null)
        msgs = ((InternalEObject)newIdentifier_list_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.IDENTIFIER_LIST__IDENTIFIER_LIST_LINHA, null, msgs);
      msgs = basicSetIdentifier_list_linha(newIdentifier_list_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.IDENTIFIER_LIST__IDENTIFIER_LIST_LINHA, newIdentifier_list_linha, newIdentifier_list_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.IDENTIFIER_LIST__IDENTIFIER_LIST_LINHA:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AnsicPackage.IDENTIFIER_LIST__IDENTIFIER:
