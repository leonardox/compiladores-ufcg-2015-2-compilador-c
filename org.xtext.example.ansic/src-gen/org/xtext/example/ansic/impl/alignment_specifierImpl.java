 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.alignment_specifierImpl#getType_name <em>Type name</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.alignment_specifierImpl#getConstant_expression <em>Constant expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class alignment_specifierImpl extends MinimalEObjectImpl.Container implements alignment_specifier
{
  ...
  {
    return AnsicPackage.Literals.ALIGNMENT_SPECIFIER;
  }
  ...
  public NotificationChain basicSetType_name(type_name newType_name, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.ALIGNMENT_SPECIFIER__TYPE_NAME, oldType_name, newType_name);
  ...
  public void setType_name(type_name newType_name)
  {
    if (newType_name != type_name)
    {
      ...
      if (type_name != null)
        msgs = ((InternalEObject)type_name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.ALIGNMENT_SPECIFIER__TYPE_NAME, null, msgs);
      if (newType_name != null)
        msgs = ((InternalEObject)newType_name).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.ALIGNMENT_SPECIFIER__TYPE_NAME, null, msgs);
      msgs = basicSetType_name(newType_name, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.ALIGNMENT_SPECIFIER__TYPE_NAME, newType_name, newType_name));
  }
  ...
  public NotificationChain basicSetConstant_expression(constant_expression newConstant_expression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.ALIGNMENT_SPECIFIER__CONSTANT_EXPRESSION, oldConstant_expression, newConstant_expression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setConstant_expression(constant_expression newConstant_expression)
  {
    if (newConstant_expression != constant_expression)
    {
      ...
      if (constant_expression != null)
        msgs = ((InternalEObject)constant_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.ALIGNMENT_SPECIFIER__CONSTANT_EXPRESSION, null, msgs);
      if (newConstant_expression != null)
        msgs = ((InternalEObject)newConstant_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.ALIGNMENT_SPECIFIER__CONSTANT_EXPRESSION, null, msgs);
      msgs = basicSetConstant_expression(newConstant_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.ALIGNMENT_SPECIFIER__CONSTANT_EXPRESSION, newConstant_expression, newConstant_expression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.ALIGNMENT_SPECIFIER__TYPE_NAME:
        return basicSetType_name(null, msgs);
      case AnsicPackage.ALIGNMENT_SPECIFIER__CONSTANT_EXPRESSION:
