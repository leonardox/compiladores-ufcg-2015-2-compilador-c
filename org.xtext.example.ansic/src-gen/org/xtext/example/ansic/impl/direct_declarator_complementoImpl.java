 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.direct_declarator_complementoImpl#getType_qualifier_list <em>Type qualifier list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.direct_declarator_complementoImpl#getAssignment_expression <em>Assignment expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.direct_declarator_complementoImpl#getParameter_type_list <em>Parameter type list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.direct_declarator_complementoImpl#getIdentifier_list <em>Identifier list</em>}</li>
 * </ul>
 *
 * @generated
 */
public class direct_declarator_complementoImpl extends MinimalEObjectImpl.Container implements direct_declarator_complemento
{
  ...
  {
    return AnsicPackage.Literals.DIRECT_DECLARATOR_COMPLEMENTO;
  }
  ...
  public NotificationChain basicSetType_qualifier_list(type_qualifier_list newType_qualifier_list, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__TYPE_QUALIFIER_LIST, oldType_qualifier_list, newType_qualifier_list);
  ...
  public void setType_qualifier_list(type_qualifier_list newType_qualifier_list)
  {
    if (newType_qualifier_list != type_qualifier_list)
    {
      ...
      if (type_qualifier_list != null)
        msgs = ((InternalEObject)type_qualifier_list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__TYPE_QUALIFIER_LIST, null, msgs);
      if (newType_qualifier_list != null)
        msgs = ((InternalEObject)newType_qualifier_list).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__TYPE_QUALIFIER_LIST, null, msgs);
      msgs = basicSetType_qualifier_list(newType_qualifier_list, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__TYPE_QUALIFIER_LIST, newType_qualifier_list, newType_qualifier_list));
  }
  ...
  public NotificationChain basicSetAssignment_expression(assignment_expression newAssignment_expression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__ASSIGNMENT_EXPRESSION, oldAssignment_expression, newAssignment_expression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setAssignment_expression(assignment_expression newAssignment_expression)
  {
    if (newAssignment_expression != assignment_expression)
    {
      ...
      if (assignment_expression != null)
        msgs = ((InternalEObject)assignment_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__ASSIGNMENT_EXPRESSION, null, msgs);
      if (newAssignment_expression != null)
        msgs = ((InternalEObject)newAssignment_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__ASSIGNMENT_EXPRESSION, null, msgs);
      msgs = basicSetAssignment_expression(newAssignment_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__ASSIGNMENT_EXPRESSION, newAssignment_expression, newAssignment_expression));
  }
  ...
  public NotificationChain basicSetParameter_type_list(parameter_type_list newParameter_type_list, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__PARAMETER_TYPE_LIST, oldParameter_type_list, newParameter_type_list);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setParameter_type_list(parameter_type_list newParameter_type_list)
  {
    if (newParameter_type_list != parameter_type_list)
    {
      ...
      if (parameter_type_list != null)
        msgs = ((InternalEObject)parameter_type_list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__PARAMETER_TYPE_LIST, null, msgs);
      if (newParameter_type_list != null)
        msgs = ((InternalEObject)newParameter_type_list).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__PARAMETER_TYPE_LIST, null, msgs);
      msgs = basicSetParameter_type_list(newParameter_type_list, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__PARAMETER_TYPE_LIST, newParameter_type_list, newParameter_type_list));
  }
  ...
  public NotificationChain basicSetIdentifier_list(identifier_list newIdentifier_list, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__IDENTIFIER_LIST, oldIdentifier_list, newIdentifier_list);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setIdentifier_list(identifier_list newIdentifier_list)
  {
    if (newIdentifier_list != identifier_list)
    {
      ...
      if (identifier_list != null)
        msgs = ((InternalEObject)identifier_list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__IDENTIFIER_LIST, null, msgs);
      if (newIdentifier_list != null)
        msgs = ((InternalEObject)newIdentifier_list).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__IDENTIFIER_LIST, null, msgs);
      msgs = basicSetIdentifier_list(newIdentifier_list, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__IDENTIFIER_LIST, newIdentifier_list, newIdentifier_list));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__TYPE_QUALIFIER_LIST:
        return basicSetType_qualifier_list(null, msgs);
      case AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__ASSIGNMENT_EXPRESSION:
        return basicSetAssignment_expression(null, msgs);
      case AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__PARAMETER_TYPE_LIST:
        return basicSetParameter_type_list(null, msgs);
      case AnsicPackage.DIRECT_DECLARATOR_COMPLEMENTO__IDENTIFIER_LIST:
