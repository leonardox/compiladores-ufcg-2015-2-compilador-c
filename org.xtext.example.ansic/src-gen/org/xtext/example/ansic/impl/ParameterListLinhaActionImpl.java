...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Parameter List Linha Action</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.ParameterListLinhaActionImpl#getParameter_declaration <em>Parameter declaration</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.ParameterListLinhaActionImpl#getParameter_list_linha <em>Parameter list linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterListLinhaActionImpl extends parameter_list_linhaImpl implements ParameterListLinhaAction
{
  /**
   ...
   * @generated
   */
  protected ParameterListLinhaActionImpl()
  {
    super();
  }
  ...
  {
    return AnsicPackage.Literals.PARAMETER_LIST_LINHA_ACTION;
  }
  ...
  public NotificationChain basicSetParameter_declaration(parameter_declaration newParameter_declaration, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.PARAMETER_LIST_LINHA_ACTION__PARAMETER_DECLARATION, oldParameter_declaration, newParameter_declaration);
  ...
  public void setParameter_declaration(parameter_declaration newParameter_declaration)
  {
    if (newParameter_declaration != parameter_declaration)
    {
      ...
      if (parameter_declaration != null)
        msgs = ((InternalEObject)parameter_declaration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.PARAMETER_LIST_LINHA_ACTION__PARAMETER_DECLARATION, null, msgs);
      if (newParameter_declaration != null)
        msgs = ((InternalEObject)newParameter_declaration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.PARAMETER_LIST_LINHA_ACTION__PARAMETER_DECLARATION, null, msgs);
      msgs = basicSetParameter_declaration(newParameter_declaration, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.PARAMETER_LIST_LINHA_ACTION__PARAMETER_DECLARATION, newParameter_declaration, newParameter_declaration));
  }
  ...
  public NotificationChain basicSetParameter_list_linha(parameter_list_linha newParameter_list_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.PARAMETER_LIST_LINHA_ACTION__PARAMETER_LIST_LINHA, oldParameter_list_linha, newParameter_list_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setParameter_list_linha(parameter_list_linha newParameter_list_linha)
  {
    if (newParameter_list_linha != parameter_list_linha)
    {
      ...
      if (parameter_list_linha != null)
        msgs = ((InternalEObject)parameter_list_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.PARAMETER_LIST_LINHA_ACTION__PARAMETER_LIST_LINHA, null, msgs);
      if (newParameter_list_linha != null)
        msgs = ((InternalEObject)newParameter_list_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.PARAMETER_LIST_LINHA_ACTION__PARAMETER_LIST_LINHA, null, msgs);
      msgs = basicSetParameter_list_linha(newParameter_list_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.PARAMETER_LIST_LINHA_ACTION__PARAMETER_LIST_LINHA, newParameter_list_linha, newParameter_list_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.PARAMETER_LIST_LINHA_ACTION__PARAMETER_DECLARATION:
        return basicSetParameter_declaration(null, msgs);
      case AnsicPackage.PARAMETER_LIST_LINHA_ACTION__PARAMETER_LIST_LINHA:
