...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>logical or expression linha</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.logical_or_expression_linhaImpl#getLogical_and_expression <em>Logical and expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.logical_or_expression_linhaImpl#getLogical_or_expression_linha <em>Logical or expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class logical_or_expression_linhaImpl extends MinimalEObjectImpl.Container implements logical_or_expression_linha
{
  /**
   ...
   * @generated
   */
  protected logical_or_expression_linhaImpl()
  {
    super();
  }
  ...
  {
    return AnsicPackage.Literals.LOGICAL_OR_EXPRESSION_LINHA;
  }
  ...
  public NotificationChain basicSetLogical_and_expression(logical_and_expression newLogical_and_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.LOGICAL_OR_EXPRESSION_LINHA__LOGICAL_AND_EXPRESSION, oldLogical_and_expression, newLogical_and_expression);
  ...
  public void setLogical_and_expression(logical_and_expression newLogical_and_expression)
  {
    if (newLogical_and_expression != logical_and_expression)
    {
      ...
      if (logical_and_expression != null)
        msgs = ((InternalEObject)logical_and_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.LOGICAL_OR_EXPRESSION_LINHA__LOGICAL_AND_EXPRESSION, null, msgs);
      if (newLogical_and_expression != null)
        msgs = ((InternalEObject)newLogical_and_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.LOGICAL_OR_EXPRESSION_LINHA__LOGICAL_AND_EXPRESSION, null, msgs);
      msgs = basicSetLogical_and_expression(newLogical_and_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.LOGICAL_OR_EXPRESSION_LINHA__LOGICAL_AND_EXPRESSION, newLogical_and_expression, newLogical_and_expression));
  }
  ...
  public NotificationChain basicSetLogical_or_expression_linha(logical_or_expression_linha newLogical_or_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.LOGICAL_OR_EXPRESSION_LINHA__LOGICAL_OR_EXPRESSION_LINHA, oldLogical_or_expression_linha, newLogical_or_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLogical_or_expression_linha(logical_or_expression_linha newLogical_or_expression_linha)
  {
    if (newLogical_or_expression_linha != logical_or_expression_linha)
    {
      ...
      if (logical_or_expression_linha != null)
        msgs = ((InternalEObject)logical_or_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.LOGICAL_OR_EXPRESSION_LINHA__LOGICAL_OR_EXPRESSION_LINHA, null, msgs);
      if (newLogical_or_expression_linha != null)
        msgs = ((InternalEObject)newLogical_or_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.LOGICAL_OR_EXPRESSION_LINHA__LOGICAL_OR_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetLogical_or_expression_linha(newLogical_or_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.LOGICAL_OR_EXPRESSION_LINHA__LOGICAL_OR_EXPRESSION_LINHA, newLogical_or_expression_linha, newLogical_or_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.LOGICAL_OR_EXPRESSION_LINHA__LOGICAL_AND_EXPRESSION:
        return basicSetLogical_and_expression(null, msgs);
      case AnsicPackage.LOGICAL_OR_EXPRESSION_LINHA__LOGICAL_OR_EXPRESSION_LINHA:
...
} //logical_or_expression_linhaImpl
