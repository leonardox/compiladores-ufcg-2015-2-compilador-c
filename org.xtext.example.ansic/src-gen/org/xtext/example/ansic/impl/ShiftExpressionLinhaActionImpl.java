...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Shift Expression Linha Action</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.ShiftExpressionLinhaActionImpl#getShift_expression_complement <em>Shift expression complement</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.ShiftExpressionLinhaActionImpl#getShift_expression_linha <em>Shift expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShiftExpressionLinhaActionImpl extends shift_expression_linhaImpl implements ShiftExpressionLinhaAction
{
  /**
   ...
   * @generated
   */
  protected ShiftExpressionLinhaActionImpl()
  {
    super();
  }
  ...
  {
    return AnsicPackage.Literals.SHIFT_EXPRESSION_LINHA_ACTION;
  }
  ...
  public NotificationChain basicSetShift_expression_complement(shift_expression_complement newShift_expression_complement, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.SHIFT_EXPRESSION_LINHA_ACTION__SHIFT_EXPRESSION_COMPLEMENT, oldShift_expression_complement, newShift_expression_complement);
  ...
  public void setShift_expression_complement(shift_expression_complement newShift_expression_complement)
  {
    if (newShift_expression_complement != shift_expression_complement)
    {
      ...
      if (shift_expression_complement != null)
        msgs = ((InternalEObject)shift_expression_complement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.SHIFT_EXPRESSION_LINHA_ACTION__SHIFT_EXPRESSION_COMPLEMENT, null, msgs);
      if (newShift_expression_complement != null)
        msgs = ((InternalEObject)newShift_expression_complement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.SHIFT_EXPRESSION_LINHA_ACTION__SHIFT_EXPRESSION_COMPLEMENT, null, msgs);
      msgs = basicSetShift_expression_complement(newShift_expression_complement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.SHIFT_EXPRESSION_LINHA_ACTION__SHIFT_EXPRESSION_COMPLEMENT, newShift_expression_complement, newShift_expression_complement));
  }
  ...
  public NotificationChain basicSetShift_expression_linha(shift_expression_linha newShift_expression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.SHIFT_EXPRESSION_LINHA_ACTION__SHIFT_EXPRESSION_LINHA, oldShift_expression_linha, newShift_expression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setShift_expression_linha(shift_expression_linha newShift_expression_linha)
  {
    if (newShift_expression_linha != shift_expression_linha)
    {
      ...
      if (shift_expression_linha != null)
        msgs = ((InternalEObject)shift_expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.SHIFT_EXPRESSION_LINHA_ACTION__SHIFT_EXPRESSION_LINHA, null, msgs);
      if (newShift_expression_linha != null)
        msgs = ((InternalEObject)newShift_expression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.SHIFT_EXPRESSION_LINHA_ACTION__SHIFT_EXPRESSION_LINHA, null, msgs);
      msgs = basicSetShift_expression_linha(newShift_expression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.SHIFT_EXPRESSION_LINHA_ACTION__SHIFT_EXPRESSION_LINHA, newShift_expression_linha, newShift_expression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.SHIFT_EXPRESSION_LINHA_ACTION__SHIFT_EXPRESSION_COMPLEMENT:
        return basicSetShift_expression_complement(null, msgs);
      case AnsicPackage.SHIFT_EXPRESSION_LINHA_ACTION__SHIFT_EXPRESSION_LINHA:
...
} //ShiftExpressionLinhaActionImpl
