 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.direct_abstract_declaratorImpl#getAbstract_declarator <em>Abstract declarator</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.direct_abstract_declaratorImpl#getType_qualifier_list <em>Type qualifier list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.direct_abstract_declaratorImpl#getAssignment_expression <em>Assignment expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.direct_abstract_declaratorImpl#getParameter_type_list <em>Parameter type list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.direct_abstract_declaratorImpl#getDirect_abstract_declarator_linha <em>Direct abstract declarator linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class direct_abstract_declaratorImpl extends MinimalEObjectImpl.Container implements direct_abstract_declarator
{
  ...
  {
    return AnsicPackage.Literals.DIRECT_ABSTRACT_DECLARATOR;
  }
  ...
  public NotificationChain basicSetAbstract_declarator(abstract_declarator newAbstract_declarator, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__ABSTRACT_DECLARATOR, oldAbstract_declarator, newAbstract_declarator);
  ...
  public void setAbstract_declarator(abstract_declarator newAbstract_declarator)
  {
    if (newAbstract_declarator != abstract_declarator)
    {
      ...
      if (abstract_declarator != null)
        msgs = ((InternalEObject)abstract_declarator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__ABSTRACT_DECLARATOR, null, msgs);
      if (newAbstract_declarator != null)
        msgs = ((InternalEObject)newAbstract_declarator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__ABSTRACT_DECLARATOR, null, msgs);
      msgs = basicSetAbstract_declarator(newAbstract_declarator, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__ABSTRACT_DECLARATOR, newAbstract_declarator, newAbstract_declarator));
  }
  ...
  public NotificationChain basicSetType_qualifier_list(type_qualifier_list newType_qualifier_list, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__TYPE_QUALIFIER_LIST, oldType_qualifier_list, newType_qualifier_list);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setType_qualifier_list(type_qualifier_list newType_qualifier_list)
  {
    if (newType_qualifier_list != type_qualifier_list)
    {
      ...
      if (type_qualifier_list != null)
        msgs = ((InternalEObject)type_qualifier_list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__TYPE_QUALIFIER_LIST, null, msgs);
      if (newType_qualifier_list != null)
        msgs = ((InternalEObject)newType_qualifier_list).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__TYPE_QUALIFIER_LIST, null, msgs);
      msgs = basicSetType_qualifier_list(newType_qualifier_list, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__TYPE_QUALIFIER_LIST, newType_qualifier_list, newType_qualifier_list));
  }
  ...
  public NotificationChain basicSetAssignment_expression(assignment_expression newAssignment_expression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__ASSIGNMENT_EXPRESSION, oldAssignment_expression, newAssignment_expression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setAssignment_expression(assignment_expression newAssignment_expression)
  {
    if (newAssignment_expression != assignment_expression)
    {
      ...
      if (assignment_expression != null)
        msgs = ((InternalEObject)assignment_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__ASSIGNMENT_EXPRESSION, null, msgs);
      if (newAssignment_expression != null)
        msgs = ((InternalEObject)newAssignment_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__ASSIGNMENT_EXPRESSION, null, msgs);
      msgs = basicSetAssignment_expression(newAssignment_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__ASSIGNMENT_EXPRESSION, newAssignment_expression, newAssignment_expression));
  }
  ...
  public NotificationChain basicSetParameter_type_list(parameter_type_list newParameter_type_list, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__PARAMETER_TYPE_LIST, oldParameter_type_list, newParameter_type_list);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setParameter_type_list(parameter_type_list newParameter_type_list)
  {
    if (newParameter_type_list != parameter_type_list)
    {
      ...
      if (parameter_type_list != null)
        msgs = ((InternalEObject)parameter_type_list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__PARAMETER_TYPE_LIST, null, msgs);
      if (newParameter_type_list != null)
        msgs = ((InternalEObject)newParameter_type_list).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__PARAMETER_TYPE_LIST, null, msgs);
      msgs = basicSetParameter_type_list(newParameter_type_list, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__PARAMETER_TYPE_LIST, newParameter_type_list, newParameter_type_list));
  }
  ...
  public NotificationChain basicSetDirect_abstract_declarator_linha(direct_abstract_declarator_linha newDirect_abstract_declarator_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR_LINHA, oldDirect_abstract_declarator_linha, newDirect_abstract_declarator_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDirect_abstract_declarator_linha(direct_abstract_declarator_linha newDirect_abstract_declarator_linha)
  {
    if (newDirect_abstract_declarator_linha != direct_abstract_declarator_linha)
    {
      ...
      if (direct_abstract_declarator_linha != null)
        msgs = ((InternalEObject)direct_abstract_declarator_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR_LINHA, null, msgs);
      if (newDirect_abstract_declarator_linha != null)
        msgs = ((InternalEObject)newDirect_abstract_declarator_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR_LINHA, null, msgs);
      msgs = basicSetDirect_abstract_declarator_linha(newDirect_abstract_declarator_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR_LINHA, newDirect_abstract_declarator_linha, newDirect_abstract_declarator_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__ABSTRACT_DECLARATOR:
        return basicSetAbstract_declarator(null, msgs);
      case AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__TYPE_QUALIFIER_LIST:
        return basicSetType_qualifier_list(null, msgs);
      case AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__ASSIGNMENT_EXPRESSION:
        return basicSetAssignment_expression(null, msgs);
      case AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__PARAMETER_TYPE_LIST:
        return basicSetParameter_type_list(null, msgs);
      case AnsicPackage.DIRECT_ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR_LINHA:
