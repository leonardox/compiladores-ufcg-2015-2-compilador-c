 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.atomic_type_specifierImpl#getType_name <em>Type name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class atomic_type_specifierImpl extends MinimalEObjectImpl.Container implements atomic_type_specifier
{
  ...
  {
    return AnsicPackage.Literals.ATOMIC_TYPE_SPECIFIER;
  }
  ...
  public NotificationChain basicSetType_name(type_name newType_name, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.ATOMIC_TYPE_SPECIFIER__TYPE_NAME, oldType_name, newType_name);
  ...
  public void setType_name(type_name newType_name)
  {
    if (newType_name != type_name)
    {
      ...
      if (type_name != null)
        msgs = ((InternalEObject)type_name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.ATOMIC_TYPE_SPECIFIER__TYPE_NAME, null, msgs);
      if (newType_name != null)
        msgs = ((InternalEObject)newType_name).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.ATOMIC_TYPE_SPECIFIER__TYPE_NAME, null, msgs);
      msgs = basicSetType_name(newType_name, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.ATOMIC_TYPE_SPECIFIER__TYPE_NAME, newType_name, newType_name));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.ATOMIC_TYPE_SPECIFIER__TYPE_NAME:
