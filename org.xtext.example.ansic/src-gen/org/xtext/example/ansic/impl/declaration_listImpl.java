 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.declaration_listImpl#getDeclaration <em>Declaration</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.declaration_listImpl#getDeclaration_list_linha <em>Declaration list linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class declaration_listImpl extends MinimalEObjectImpl.Container implements declaration_list
{
  ...
  {
    return AnsicPackage.Literals.DECLARATION_LIST;
  }
  ...
  public NotificationChain basicSetDeclaration(declaration newDeclaration, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DECLARATION_LIST__DECLARATION, oldDeclaration, newDeclaration);
  ...
  public void setDeclaration(declaration newDeclaration)
  {
    if (newDeclaration != declaration)
    {
      ...
      if (declaration != null)
        msgs = ((InternalEObject)declaration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DECLARATION_LIST__DECLARATION, null, msgs);
      if (newDeclaration != null)
        msgs = ((InternalEObject)newDeclaration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DECLARATION_LIST__DECLARATION, null, msgs);
      msgs = basicSetDeclaration(newDeclaration, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DECLARATION_LIST__DECLARATION, newDeclaration, newDeclaration));
  }
  ...
  public NotificationChain basicSetDeclaration_list_linha(declaration_list_linha newDeclaration_list_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.DECLARATION_LIST__DECLARATION_LIST_LINHA, oldDeclaration_list_linha, newDeclaration_list_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDeclaration_list_linha(declaration_list_linha newDeclaration_list_linha)
  {
    if (newDeclaration_list_linha != declaration_list_linha)
    {
      ...
      if (declaration_list_linha != null)
        msgs = ((InternalEObject)declaration_list_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DECLARATION_LIST__DECLARATION_LIST_LINHA, null, msgs);
      if (newDeclaration_list_linha != null)
        msgs = ((InternalEObject)newDeclaration_list_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.DECLARATION_LIST__DECLARATION_LIST_LINHA, null, msgs);
      msgs = basicSetDeclaration_list_linha(newDeclaration_list_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.DECLARATION_LIST__DECLARATION_LIST_LINHA, newDeclaration_list_linha, newDeclaration_list_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.DECLARATION_LIST__DECLARATION:
        return basicSetDeclaration(null, msgs);
      case AnsicPackage.DECLARATION_LIST__DECLARATION_LIST_LINHA:
