 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.type_qualifier_listImpl#getType_qualifier <em>Type qualifier</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.type_qualifier_listImpl#getType_qualifier_list_linha <em>Type qualifier list linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class type_qualifier_listImpl extends direct_abstract_declarator_complementImpl implements type_qualifier_list
{
  ...
  {
    return AnsicPackage.Literals.TYPE_QUALIFIER_LIST;
  }
  ...
  public NotificationChain basicSetType_qualifier(type_qualifier newType_qualifier, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER, oldType_qualifier, newType_qualifier);
  ...
  public void setType_qualifier(type_qualifier newType_qualifier)
  {
    if (newType_qualifier != type_qualifier)
    {
      ...
      if (type_qualifier != null)
        msgs = ((InternalEObject)type_qualifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER, null, msgs);
      if (newType_qualifier != null)
        msgs = ((InternalEObject)newType_qualifier).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER, null, msgs);
      msgs = basicSetType_qualifier(newType_qualifier, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER, newType_qualifier, newType_qualifier));
  }
  ...
  public NotificationChain basicSetType_qualifier_list_linha(type_qualifier_list_linha newType_qualifier_list_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER_LIST_LINHA, oldType_qualifier_list_linha, newType_qualifier_list_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setType_qualifier_list_linha(type_qualifier_list_linha newType_qualifier_list_linha)
  {
    if (newType_qualifier_list_linha != type_qualifier_list_linha)
    {
      ...
      if (type_qualifier_list_linha != null)
        msgs = ((InternalEObject)type_qualifier_list_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER_LIST_LINHA, null, msgs);
      if (newType_qualifier_list_linha != null)
        msgs = ((InternalEObject)newType_qualifier_list_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER_LIST_LINHA, null, msgs);
      msgs = basicSetType_qualifier_list_linha(newType_qualifier_list_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER_LIST_LINHA, newType_qualifier_list_linha, newType_qualifier_list_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER:
        return basicSetType_qualifier(null, msgs);
      case AnsicPackage.TYPE_QUALIFIER_LIST__TYPE_QUALIFIER_LIST_LINHA:
