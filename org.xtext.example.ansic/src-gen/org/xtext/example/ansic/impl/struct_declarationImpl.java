 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.struct_declarationImpl#getSpecifier_qualifier_list <em>Specifier qualifier list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.struct_declarationImpl#getStruct_declarator_list <em>Struct declarator list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.struct_declarationImpl#getStatic_assert_declaration <em>Static assert declaration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class struct_declarationImpl extends MinimalEObjectImpl.Container implements struct_declaration
{
  ...
  {
    return AnsicPackage.Literals.STRUCT_DECLARATION;
  }
  ...
  public NotificationChain basicSetSpecifier_qualifier_list(specifier_qualifier_list newSpecifier_qualifier_list, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.STRUCT_DECLARATION__SPECIFIER_QUALIFIER_LIST, oldSpecifier_qualifier_list, newSpecifier_qualifier_list);
  ...
  public void setSpecifier_qualifier_list(specifier_qualifier_list newSpecifier_qualifier_list)
  {
    if (newSpecifier_qualifier_list != specifier_qualifier_list)
    {
      ...
      if (specifier_qualifier_list != null)
        msgs = ((InternalEObject)specifier_qualifier_list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STRUCT_DECLARATION__SPECIFIER_QUALIFIER_LIST, null, msgs);
      if (newSpecifier_qualifier_list != null)
        msgs = ((InternalEObject)newSpecifier_qualifier_list).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STRUCT_DECLARATION__SPECIFIER_QUALIFIER_LIST, null, msgs);
      msgs = basicSetSpecifier_qualifier_list(newSpecifier_qualifier_list, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.STRUCT_DECLARATION__SPECIFIER_QUALIFIER_LIST, newSpecifier_qualifier_list, newSpecifier_qualifier_list));
  }
  ...
  public NotificationChain basicSetStruct_declarator_list(struct_declarator_list newStruct_declarator_list, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.STRUCT_DECLARATION__STRUCT_DECLARATOR_LIST, oldStruct_declarator_list, newStruct_declarator_list);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStruct_declarator_list(struct_declarator_list newStruct_declarator_list)
  {
    if (newStruct_declarator_list != struct_declarator_list)
    {
      ...
      if (struct_declarator_list != null)
        msgs = ((InternalEObject)struct_declarator_list).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STRUCT_DECLARATION__STRUCT_DECLARATOR_LIST, null, msgs);
      if (newStruct_declarator_list != null)
        msgs = ((InternalEObject)newStruct_declarator_list).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STRUCT_DECLARATION__STRUCT_DECLARATOR_LIST, null, msgs);
      msgs = basicSetStruct_declarator_list(newStruct_declarator_list, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.STRUCT_DECLARATION__STRUCT_DECLARATOR_LIST, newStruct_declarator_list, newStruct_declarator_list));
  }
  ...
  public NotificationChain basicSetStatic_assert_declaration(static_assert_declaration newStatic_assert_declaration, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.STRUCT_DECLARATION__STATIC_ASSERT_DECLARATION, oldStatic_assert_declaration, newStatic_assert_declaration);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStatic_assert_declaration(static_assert_declaration newStatic_assert_declaration)
  {
    if (newStatic_assert_declaration != static_assert_declaration)
    {
      ...
      if (static_assert_declaration != null)
        msgs = ((InternalEObject)static_assert_declaration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STRUCT_DECLARATION__STATIC_ASSERT_DECLARATION, null, msgs);
      if (newStatic_assert_declaration != null)
        msgs = ((InternalEObject)newStatic_assert_declaration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.STRUCT_DECLARATION__STATIC_ASSERT_DECLARATION, null, msgs);
      msgs = basicSetStatic_assert_declaration(newStatic_assert_declaration, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.STRUCT_DECLARATION__STATIC_ASSERT_DECLARATION, newStatic_assert_declaration, newStatic_assert_declaration));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.STRUCT_DECLARATION__SPECIFIER_QUALIFIER_LIST:
        return basicSetSpecifier_qualifier_list(null, msgs);
      case AnsicPackage.STRUCT_DECLARATION__STRUCT_DECLARATOR_LIST:
        return basicSetStruct_declarator_list(null, msgs);
      case AnsicPackage.STRUCT_DECLARATION__STATIC_ASSERT_DECLARATION:
