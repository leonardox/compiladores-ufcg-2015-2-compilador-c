 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.impl.expressionImpl#getAssignment_expression <em>Assignment expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.impl.expressionImpl#getExpression_linha <em>Expression linha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class expressionImpl extends MinimalEObjectImpl.Container implements expression
{
  ...
  {
    return AnsicPackage.Literals.EXPRESSION;
  }
  ...
  public NotificationChain basicSetAssignment_expression(assignment_expression newAssignment_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.EXPRESSION__ASSIGNMENT_EXPRESSION, oldAssignment_expression, newAssignment_expression);
  ...
  public void setAssignment_expression(assignment_expression newAssignment_expression)
  {
    if (newAssignment_expression != assignment_expression)
    {
      ...
      if (assignment_expression != null)
        msgs = ((InternalEObject)assignment_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXPRESSION__ASSIGNMENT_EXPRESSION, null, msgs);
      if (newAssignment_expression != null)
        msgs = ((InternalEObject)newAssignment_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXPRESSION__ASSIGNMENT_EXPRESSION, null, msgs);
      msgs = basicSetAssignment_expression(newAssignment_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.EXPRESSION__ASSIGNMENT_EXPRESSION, newAssignment_expression, newAssignment_expression));
  }
  ...
  public NotificationChain basicSetExpression_linha(expression_linha newExpression_linha, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AnsicPackage.EXPRESSION__EXPRESSION_LINHA, oldExpression_linha, newExpression_linha);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExpression_linha(expression_linha newExpression_linha)
  {
    if (newExpression_linha != expression_linha)
    {
      ...
      if (expression_linha != null)
        msgs = ((InternalEObject)expression_linha).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXPRESSION__EXPRESSION_LINHA, null, msgs);
      if (newExpression_linha != null)
        msgs = ((InternalEObject)newExpression_linha).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AnsicPackage.EXPRESSION__EXPRESSION_LINHA, null, msgs);
      msgs = basicSetExpression_linha(newExpression_linha, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AnsicPackage.EXPRESSION__EXPRESSION_LINHA, newExpression_linha, newExpression_linha));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AnsicPackage.EXPRESSION__ASSIGNMENT_EXPRESSION:
        return basicSetAssignment_expression(null, msgs);
      case AnsicPackage.EXPRESSION__EXPRESSION_LINHA:
