 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.specifier_qualifier_list#getType_specifier <em>Type specifier</em>}</li>
 *   <li>{@link org.xtext.example.ansic.specifier_qualifier_list#getSpecifier_qualifier_list <em>Specifier qualifier list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.specifier_qualifier_list#getType_qualifier <em>Type qualifier</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#getspecifier_qualifier_list()
 * @model
 * @generated
 */
public interface specifier_qualifier_list extends EObject
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getspecifier_qualifier_list_Type_specifier()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.specifier_qualifier_list#getType_specifier <em>Type specifier</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getspecifier_qualifier_list_Specifier_qualifier_list()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.specifier_qualifier_list#getSpecifier_qualifier_list <em>Specifier qualifier list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getspecifier_qualifier_list_Type_qualifier()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.specifier_qualifier_list#getType_qualifier <em>Type qualifier</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
