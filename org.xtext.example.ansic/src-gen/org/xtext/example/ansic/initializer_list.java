 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.initializer_list#getDesignation <em>Designation</em>}</li>
 *   <li>{@link org.xtext.example.ansic.initializer_list#getInitializer <em>Initializer</em>}</li>
 *   <li>{@link org.xtext.example.ansic.initializer_list#getInit_declarator_list_linha <em>Init declarator list linha</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#getinitializer_list()
 * @model
 * @generated
 */
public interface initializer_list extends EObject
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getinitializer_list_Designation()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.initializer_list#getDesignation <em>Designation</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getinitializer_list_Initializer()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.initializer_list#getInitializer <em>Initializer</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getinitializer_list_Init_declarator_list_linha()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.initializer_list#getInit_declarator_list_linha <em>Init declarator list linha</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
