 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.type_name#getInitializer_list <em>Initializer list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.type_name#getSpecifier_qualifier_list <em>Specifier qualifier list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.type_name#getAbstract_declarator <em>Abstract declarator</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#gettype_name()
 * @model
 * @generated
 */
public interface type_name extends postfix_expression
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#gettype_name_Initializer_list()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.type_name#getInitializer_list <em>Initializer list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#gettype_name_Specifier_qualifier_list()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.type_name#getSpecifier_qualifier_list <em>Specifier qualifier list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#gettype_name_Abstract_declarator()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.type_name#getAbstract_declarator <em>Abstract declarator</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
