 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.generic_selection#get_generic <em>generic</em>}</li>
 *   <li>{@link org.xtext.example.ansic.generic_selection#getAssignment_expression <em>Assignment expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.generic_selection#getGeneric_assoc_list <em>Generic assoc list</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#getgeneric_selection()
 * @model
 * @generated
 */
public interface generic_selection extends EObject
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getgeneric_selection__generic()
   * @model
   * @generated
   */
  String get_generic();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.generic_selection#get_generic <em>generic</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getgeneric_selection_Assignment_expression()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.generic_selection#getAssignment_expression <em>Assignment expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.xtext.example.ansic.generic_assoc_list}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getgeneric_selection_Generic_assoc_list()
   * @model containment="true"
   * @generated
   */
