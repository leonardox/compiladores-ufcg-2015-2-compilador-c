 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.direct_declarator_complemento#getType_qualifier_list <em>Type qualifier list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.direct_declarator_complemento#getAssignment_expression <em>Assignment expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.direct_declarator_complemento#getParameter_type_list <em>Parameter type list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.direct_declarator_complemento#getIdentifier_list <em>Identifier list</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#getdirect_declarator_complemento()
 * @model
 * @generated
 */
public interface direct_declarator_complemento extends EObject
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getdirect_declarator_complemento_Type_qualifier_list()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.direct_declarator_complemento#getType_qualifier_list <em>Type qualifier list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getdirect_declarator_complemento_Assignment_expression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.direct_declarator_complemento#getAssignment_expression <em>Assignment expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getdirect_declarator_complemento_Parameter_type_list()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.direct_declarator_complemento#getParameter_type_list <em>Parameter type list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getdirect_declarator_complemento_Identifier_list()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.direct_declarator_complemento#getIdentifier_list <em>Identifier list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
