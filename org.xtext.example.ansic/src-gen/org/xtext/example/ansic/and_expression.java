 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.and_expression#getEquality_expression <em>Equality expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.and_expression#getAnd_expression_linha <em>And expression linha</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#getand_expression()
 * @model
 * @generated
 */
public interface and_expression extends EObject
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getand_expression_Equality_expression()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.and_expression#getEquality_expression <em>Equality expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getand_expression_And_expression_linha()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.and_expression#getAnd_expression_linha <em>And expression linha</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
