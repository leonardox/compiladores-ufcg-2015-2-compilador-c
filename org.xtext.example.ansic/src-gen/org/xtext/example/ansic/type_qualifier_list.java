 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.type_qualifier_list#getType_qualifier <em>Type qualifier</em>}</li>
 *   <li>{@link org.xtext.example.ansic.type_qualifier_list#getType_qualifier_list_linha <em>Type qualifier list linha</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#gettype_qualifier_list()
 * @model
 * @generated
 */
public interface type_qualifier_list extends direct_abstract_declarator_complement
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#gettype_qualifier_list_Type_qualifier()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.type_qualifier_list#getType_qualifier <em>Type qualifier</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#gettype_qualifier_list_Type_qualifier_list_linha()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.type_qualifier_list#getType_qualifier_list_linha <em>Type qualifier list linha</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
