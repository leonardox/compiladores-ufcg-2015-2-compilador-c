 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.direct_abstract_declarator#getAbstract_declarator <em>Abstract declarator</em>}</li>
 *   <li>{@link org.xtext.example.ansic.direct_abstract_declarator#getType_qualifier_list <em>Type qualifier list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.direct_abstract_declarator#getAssignment_expression <em>Assignment expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.direct_abstract_declarator#getParameter_type_list <em>Parameter type list</em>}</li>
 *   <li>{@link org.xtext.example.ansic.direct_abstract_declarator#getDirect_abstract_declarator_linha <em>Direct abstract declarator linha</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#getdirect_abstract_declarator()
 * @model
 * @generated
 */
public interface direct_abstract_declarator extends EObject
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getdirect_abstract_declarator_Abstract_declarator()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.direct_abstract_declarator#getAbstract_declarator <em>Abstract declarator</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getdirect_abstract_declarator_Type_qualifier_list()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.direct_abstract_declarator#getType_qualifier_list <em>Type qualifier list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getdirect_abstract_declarator_Assignment_expression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.direct_abstract_declarator#getAssignment_expression <em>Assignment expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getdirect_abstract_declarator_Parameter_type_list()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.direct_abstract_declarator#getParameter_type_list <em>Parameter type list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getdirect_abstract_declarator_Direct_abstract_declarator_linha()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.direct_abstract_declarator#getDirect_abstract_declarator_linha <em>Direct abstract declarator linha</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
