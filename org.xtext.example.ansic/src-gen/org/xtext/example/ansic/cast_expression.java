 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.cast_expression#getUnary_expression <em>Unary expression</em>}</li>
 *   <li>{@link org.xtext.example.ansic.cast_expression#getType_name <em>Type name</em>}</li>
 *   <li>{@link org.xtext.example.ansic.cast_expression#getCast_expression <em>Cast expression</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#getcast_expression()
 * @model
 * @generated
 */
public interface cast_expression extends EObject
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getcast_expression_Unary_expression()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.cast_expression#getUnary_expression <em>Unary expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getcast_expression_Type_name()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.cast_expression#getType_name <em>Type name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getcast_expression_Cast_expression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.cast_expression#getCast_expression <em>Cast expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
