 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.EnumeratorListLinhaAction#getEnumerator <em>Enumerator</em>}</li>
 *   <li>{@link org.xtext.example.ansic.EnumeratorListLinhaAction#getEnumerator_list_linha <em>Enumerator list linha</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#getEnumeratorListLinhaAction()
 * @model
 * @generated
 */
public interface EnumeratorListLinhaAction extends enumerator_list_linha
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getEnumeratorListLinhaAction_Enumerator()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.EnumeratorListLinhaAction#getEnumerator <em>Enumerator</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getEnumeratorListLinhaAction_Enumerator_list_linha()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.EnumeratorListLinhaAction#getEnumerator_list_linha <em>Enumerator list linha</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
