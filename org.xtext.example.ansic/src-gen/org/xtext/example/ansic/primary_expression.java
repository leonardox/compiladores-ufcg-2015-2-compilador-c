 ...
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#getprimary_expression()
 * @model
 * @generated
 */
public interface primary_expression extends EObject
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getprimary_expression_Identifier()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.primary_expression#getIdentifier <em>Identifier</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getprimary_expression_Constant()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.primary_expression#getConstant <em>Constant</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getprimary_expression_Expression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.primary_expression#getExpression <em>Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getprimary_expression_Generic_selection()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.primary_expression#getGeneric_selection <em>Generic selection</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
