 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.ansic.parameter_declaration#getDeclaration_specifiers <em>Declaration specifiers</em>}</li>
 *   <li>{@link org.xtext.example.ansic.parameter_declaration#getDeclarator <em>Declarator</em>}</li>
 *   <li>{@link org.xtext.example.ansic.parameter_declaration#getAbstract_declarator <em>Abstract declarator</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.ansic.AnsicPackage#getparameter_declaration()
 * @model
 * @generated
 */
public interface parameter_declaration extends EObject
{
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getparameter_declaration_Declaration_specifiers()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.parameter_declaration#getDeclaration_specifiers <em>Declaration specifiers</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getparameter_declaration_Declarator()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.parameter_declaration#getDeclarator <em>Declarator</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.ansic.AnsicPackage#getparameter_declaration_Abstract_declarator()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.ansic.parameter_declaration#getAbstract_declarator <em>Abstract declarator</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
